...
public class T_Login extends Fragment implements I_Login {
    ...
    Le agregue este metodo para que al finalizar la sincronización inicial llame a la pantalla de login 
    en ocaciones no funciona pero si vuelves a ejecutarlo desde eclipse te inicia la aplicacion con la ventana de login sin
    necesidad de sincronizar de nuevo
    

    @Override
	public void onResume() {
    	super.onResume();
    	//	Obtain User and Password of Context
    	String p_User = Env.getContext("#SUser");
    	String p_Pass = Env.getContext("#SPass");
		//	
