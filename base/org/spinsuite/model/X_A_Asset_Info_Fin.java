...
public class X_A_Asset_Info_Fin extends PO implements I_A_Asset_Info_Fin
{
    ...
    public X_A_Asset_Info_Fin (Context ctx, int A_Asset_Info_Fin_ID, DB conn)
    {
      super (ctx, A_Asset_Info_Fin_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Info_Fin (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Info_Fin_ID (int A_Asset_Info_Fin_ID)
	{
		if (A_Asset_Info_Fin_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Info_Fin_ID, null);
		else 
	...
	public void setA_Contract_Date (Date A_Contract_Date)
	{
	...
	public Date getA_Contract_Date () 
	{
		return (Date)get_Value(COLUMNNAME_A_Contract_Date);
	}
	...
	public void setA_Expired_Date (Date A_Expired_Date)
	{
	...
	public Date getA_Expired_Date () 
	{
		return (Date)get_Value(COLUMNNAME_A_Expired_Date);
	}
