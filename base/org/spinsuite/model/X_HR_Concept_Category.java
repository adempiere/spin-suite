...
public class X_HR_Concept_Category extends PO implements I_HR_Concept_Category
{
    ...
    public X_HR_Concept_Category (Context ctx, int HR_Concept_Category_ID, DB conn)
    {
      super (ctx, HR_Concept_Category_ID, conn);
    ...
    /** Load Constructor */
    public X_HR_Concept_Category (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
