...
public class X_HR_PayrollConcept extends PO implements I_HR_PayrollConcept
{
    ...
    public X_HR_PayrollConcept (Context ctx, int HR_PayrollConcept_ID, DB conn)
    {
      super (ctx, HR_PayrollConcept_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_HR_PayrollConcept (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
