...
public class X_AD_FieldGroup extends PO implements I_AD_FieldGroup
{
    ...
    public X_AD_FieldGroup (Context ctx, int AD_FieldGroup_ID, DB conn)
    {
      super (ctx, AD_FieldGroup_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_FieldGroup (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
