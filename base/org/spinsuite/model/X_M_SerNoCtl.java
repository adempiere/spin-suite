...
public class X_M_SerNoCtl extends PO implements I_M_SerNoCtl
{
    ...
    public X_M_SerNoCtl (Context ctx, int M_SerNoCtl_ID, DB conn)
    {
      super (ctx, M_SerNoCtl_ID, conn);
      /** if (M_SerNoCtl_ID == 0)
        {
			setCurrentNext (0);
// 100
...
// 100
    ...
    /** Load Constructor */
    public X_M_SerNoCtl (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
