...
public class X_AD_HouseKeeping extends PO implements I_AD_HouseKeeping
{
    ...
    public X_AD_HouseKeeping (Context ctx, int AD_HouseKeeping_ID, DB conn)
    {
      super (ctx, AD_HouseKeeping_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_HouseKeeping (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_HouseKeeping_ID (int AD_HouseKeeping_ID)
	{
		if (AD_HouseKeeping_ID < 1) 
			set_Value (COLUMNNAME_AD_HouseKeeping_ID, null);
		else 
			set_Value (COLUMNNAME_AD_HouseKeeping_ID, Integer.valueOf(AD_HouseKeeping_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_LastRun);
	}
