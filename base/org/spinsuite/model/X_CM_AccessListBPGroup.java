...
public class X_CM_AccessListBPGroup extends PO implements I_CM_AccessListBPGroup
{
    ...
    public X_CM_AccessListBPGroup (Context ctx, int CM_AccessListBPGroup_ID, DB conn)
    {
      super (ctx, CM_AccessListBPGroup_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_AccessListBPGroup (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
