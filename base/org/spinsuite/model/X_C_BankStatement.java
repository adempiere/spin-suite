...
public class X_C_BankStatement extends PO implements I_C_BankStatement
{
    ...
    public X_C_BankStatement (Context ctx, int C_BankStatement_ID, DB conn)
    {
      super (ctx, C_BankStatement_ID, conn);
...
// N
			setProcessed (false);
			setStatementDate (new Date( System.currentTimeMillis() ));
// @Date@
        } */
    }

    /** Load Constructor */
    public X_C_BankStatement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
