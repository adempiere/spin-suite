...
public class X_C_RfQLineQty extends PO implements I_C_RfQLineQty
{
    ...
    public X_C_RfQLineQty (Context ctx, int C_RfQLineQty_ID, DB conn)
    {
      super (ctx, C_RfQLineQty_ID, conn);
...
// 1
    ...
    /** Load Constructor */
    public X_C_RfQLineQty (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
