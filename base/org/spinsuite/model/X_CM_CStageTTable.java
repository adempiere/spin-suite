...
public class X_CM_CStageTTable extends PO implements I_CM_CStageTTable
{
    ...
    public X_CM_CStageTTable (Context ctx, int CM_CStageTTable_ID, DB conn)
    {
      super (ctx, CM_CStageTTable_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_CStageTTable (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (CM_CStage_ID < 1) 
			set_Value (COLUMNNAME_CM_CStage_ID, null);
		else 
			set_Value (COLUMNNAME_CM_CStage_ID, Integer.valueOf(CM_CStage_ID));
	}
	...
	public void setCM_CStageTTable_ID (int CM_CStageTTable_ID)
	{
		if (CM_CStageTTable_ID < 1) 
			set_Value (COLUMNNAME_CM_CStageTTable_ID, null);
		else 
			set_Value (COLUMNNAME_CM_CStageTTable_ID, Integer.valueOf(CM_CStageTTable_ID));
	}
	...
	public void setCM_TemplateTable_ID (int CM_TemplateTable_ID)
	{
		if (CM_TemplateTable_ID < 1) 
			set_Value (COLUMNNAME_CM_TemplateTable_ID, null);
		else 
			set_Value (COLUMNNAME_CM_TemplateTable_ID, Integer.valueOf(CM_TemplateTable_ID));
	}
