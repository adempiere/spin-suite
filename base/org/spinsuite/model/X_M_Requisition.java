...
public class X_M_Requisition extends PO implements I_M_Requisition
{
    ...
    public X_M_Requisition (Context ctx, int M_Requisition_ID, DB conn)
    {
      super (ctx, M_Requisition_ID, conn);
...
// @#Date@
			setDateRequired (new Date( System.currentTimeMillis() ));
			setDocAction (null);
// CO
			setDocStatus (null);
// DR
...
// 5
    ...
    /** Load Constructor */
    public X_M_Requisition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DateRequired);
	}
