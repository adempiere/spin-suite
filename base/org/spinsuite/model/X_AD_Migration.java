...
public class X_AD_Migration extends PO implements I_AD_Migration
{
    ...
    public X_AD_Migration (Context ctx, int AD_Migration_ID, DB conn)
    {
      super (ctx, AD_Migration_ID, conn);
...
// 'U'
    ...
    /** Load Constructor */
    public X_AD_Migration (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
