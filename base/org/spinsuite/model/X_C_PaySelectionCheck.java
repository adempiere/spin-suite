...
public class X_C_PaySelectionCheck extends PO implements I_C_PaySelectionCheck
{
    ...
    public X_C_PaySelectionCheck (Context ctx, int C_PaySelectionCheck_ID, DB conn)
    {
      super (ctx, C_PaySelectionCheck_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_PaySelectionCheck (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
