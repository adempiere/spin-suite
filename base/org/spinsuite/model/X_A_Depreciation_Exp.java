...
public class X_A_Depreciation_Exp extends PO implements I_A_Depreciation_Exp
{
    ...
    public X_A_Depreciation_Exp (Context ctx, int A_Depreciation_Exp_ID, DB conn)
    {
      super (ctx, A_Depreciation_Exp_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Exp (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Depreciation_Exp_ID (int A_Depreciation_Exp_ID)
	{
		if (A_Depreciation_Exp_ID < 1) 
			set_Value (COLUMNNAME_A_Depreciation_Exp_ID, null);
		else 
			set_Value (COLUMNNAME_A_Depreciation_Exp_ID, Integer.valueOf(A_Depreciation_Exp_ID));
	}
