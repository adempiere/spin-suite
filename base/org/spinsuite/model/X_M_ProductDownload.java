...
public class X_M_ProductDownload extends PO implements I_M_ProductDownload
{
    ...
    public X_M_ProductDownload (Context ctx, int M_ProductDownload_ID, DB conn)
    {
      super (ctx, M_ProductDownload_ID, conn);
    ...
    /** Load Constructor */
    public X_M_ProductDownload (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
