...
public class X_AD_Package_Imp extends PO implements I_AD_Package_Imp
{
    ...
    public X_AD_Package_Imp (Context ctx, int AD_Package_Imp_ID, DB conn)
    {
      super (ctx, AD_Package_Imp_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Package_Imp (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
