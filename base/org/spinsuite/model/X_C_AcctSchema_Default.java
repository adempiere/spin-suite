...
public class X_C_AcctSchema_Default extends PO implements I_C_AcctSchema_Default
{
    ...
    public X_C_AcctSchema_Default (Context ctx, int C_AcctSchema_Default_ID, DB conn)
    {
      super (ctx, C_AcctSchema_Default_ID, conn);
    ...
    /** Load Constructor */
    public X_C_AcctSchema_Default (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
