...
public class X_AD_UserMail extends PO implements I_AD_UserMail
{
    ...
    public X_AD_UserMail (Context ctx, int AD_UserMail_ID, DB conn)
    {
      super (ctx, AD_UserMail_ID, conn);
      /** if (AD_UserMail_ID == 0)
        {
			setAD_User_ID (0);
			setAD_UserMail_ID (0);
    ...
    /** Load Constructor */
    public X_AD_UserMail (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (W_MailMsg_ID < 1) 
			set_Value (COLUMNNAME_W_MailMsg_ID, null);
		else 
			set_Value (COLUMNNAME_W_MailMsg_ID, Integer.valueOf(W_MailMsg_ID));
	}
