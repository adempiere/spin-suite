...
public class X_R_Resolution extends PO implements I_R_Resolution
{
    ...
    public X_R_Resolution (Context ctx, int R_Resolution_ID, DB conn)
    {
      super (ctx, R_Resolution_ID, conn);
    ...
    /** Load Constructor */
    public X_R_Resolution (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
