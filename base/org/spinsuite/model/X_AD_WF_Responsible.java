...
public class X_AD_WF_Responsible extends PO implements I_AD_WF_Responsible
{
    ...
    public X_AD_WF_Responsible (Context ctx, int AD_WF_Responsible_ID, DB conn)
    {
      super (ctx, AD_WF_Responsible_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_WF_Responsible (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
