...
public class X_M_Package extends PO implements I_M_Package
{
    ...
    public X_M_Package (Context ctx, int M_Package_ID, DB conn)
    {
      super (ctx, M_Package_ID, conn);
      /** if (M_Package_ID == 0)
        {
			setDocumentNo (null);
			setM_InOut_ID (0);
    ...
    /** Load Constructor */
    public X_M_Package (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
