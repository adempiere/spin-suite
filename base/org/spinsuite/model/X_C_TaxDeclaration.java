...
public class X_C_TaxDeclaration extends PO implements I_C_TaxDeclaration
{
    ...
    public X_C_TaxDeclaration (Context ctx, int C_TaxDeclaration_ID, DB conn)
    {
      super (ctx, C_TaxDeclaration_ID, conn);
      /** if (C_TaxDeclaration_ID == 0)
        {
			setC_TaxDeclaration_ID (0);
			setDateFrom (new Date( System.currentTimeMillis() ));
			setDateTo (new Date( System.currentTimeMillis() ));
    ...
    /** Load Constructor */
    public X_C_TaxDeclaration (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
