...
public class X_A_Asset_Reval_Index extends PO implements I_A_Asset_Reval_Index
{
    ...
    public X_A_Asset_Reval_Index (Context ctx, int A_Asset_Reval_Index_ID, DB conn)
    {
      super (ctx, A_Asset_Reval_Index_ID, conn);
      /** if (A_Asset_Reval_Index_ID == 0)
        {
			setA_Asset_Reval_Index_ID (0);
			setA_Effective_Date (new Date( System.currentTimeMillis() ));
    ...
    /** Load Constructor */
    public X_A_Asset_Reval_Index (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Reval_Index_ID (int A_Asset_Reval_Index_ID)
	{
		if (A_Asset_Reval_Index_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Reval_Index_ID, null);
		else 
	...
	public void setA_Effective_Date (Date A_Effective_Date)
	{
	...
	public Date getA_Effective_Date () 
	{
		return (Date)get_Value(COLUMNNAME_A_Effective_Date);
	}
