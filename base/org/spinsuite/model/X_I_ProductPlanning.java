...
public class X_I_ProductPlanning extends PO implements I_I_ProductPlanning
{
    ...
    public X_I_ProductPlanning (Context ctx, int I_ProductPlanning_ID, DB conn)
    {
      super (ctx, I_ProductPlanning_ID, conn);
    ...
    /** Load Constructor */
    public X_I_ProductPlanning (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setI_ProductPlanning_ID (int I_ProductPlanning_ID)
	{
		if (I_ProductPlanning_ID < 1) 
			set_Value (COLUMNNAME_I_ProductPlanning_ID, null);
		else 
			set_Value (COLUMNNAME_I_ProductPlanning_ID, Integer.valueOf(I_ProductPlanning_ID));
	}
