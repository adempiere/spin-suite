...
public class X_C_Cycle extends PO implements I_C_Cycle
{
    ...
    public X_C_Cycle (Context ctx, int C_Cycle_ID, DB conn)
    {
      super (ctx, C_Cycle_ID, conn);
      /** if (C_Cycle_ID == 0)
        {
			setC_Currency_ID (0);
			setC_Cycle_ID (0);
    ...
    /** Load Constructor */
    public X_C_Cycle (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
