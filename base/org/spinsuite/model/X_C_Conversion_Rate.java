...
public class X_C_Conversion_Rate extends PO implements I_C_Conversion_Rate
{
    ...
    public X_C_Conversion_Rate (Context ctx, int C_Conversion_Rate_ID, DB conn)
    {
      super (ctx, C_Conversion_Rate_ID, conn);
    ...
    /** Load Constructor */
    public X_C_Conversion_Rate (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
