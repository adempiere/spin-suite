...
public class X_C_Withholding extends PO implements I_C_Withholding
{
    ...
    public X_C_Withholding (Context ctx, int C_Withholding_ID, DB conn)
    {
      super (ctx, C_Withholding_ID, conn);
    ...
    /** Load Constructor */
    public X_C_Withholding (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
