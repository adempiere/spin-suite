...
public class X_C_Campaign extends PO implements I_C_Campaign
{
    ...
    public X_C_Campaign (Context ctx, int C_Campaign_ID, DB conn)
    {
      super (ctx, C_Campaign_ID, conn);
      /** if (C_Campaign_ID == 0)
        {
			setC_Campaign_ID (0);
			setCosts (Env.ZERO);
    ...
    /** Load Constructor */
    public X_C_Campaign (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
