...
public class X_AD_Package_Imp_Detail extends PO implements I_AD_Package_Imp_Detail
{
    ...
    public X_AD_Package_Imp_Detail (Context ctx, int AD_Package_Imp_Detail_ID, DB conn)
    {
      super (ctx, AD_Package_Imp_Detail_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Package_Imp_Detail (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
