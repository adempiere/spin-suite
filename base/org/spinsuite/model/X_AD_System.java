...
public class X_AD_System extends PO implements I_AD_System
{
    ...
    public X_AD_System (Context ctx, int AD_System_ID, DB conn)
    {
      super (ctx, AD_System_ID, conn);
      /** if (AD_System_ID == 0)
        {
			setAD_System_ID (0);
// 0
...
// E
    ...
    /** Load Constructor */
    public X_AD_System (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (AD_System_ID < 1) 
			set_Value (COLUMNNAME_AD_System_ID, null);
		else 
			set_Value (COLUMNNAME_AD_System_ID, Integer.valueOf(AD_System_ID));
	}
	...
	{
		set_Value (COLUMNNAME_EncryptionKey, EncryptionKey);
	}
	...
	{
		set_Value (COLUMNNAME_SupportExpDate, SupportExpDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_SupportExpDate);
	}
	...
	{
		set_Value (COLUMNNAME_SupportUnits, Integer.valueOf(SupportUnits));
	}
