...
public class X_R_CategoryUpdates extends PO implements I_R_CategoryUpdates
{
    ...
    public X_R_CategoryUpdates (Context ctx, int R_CategoryUpdates_ID, DB conn)
    {
      super (ctx, R_CategoryUpdates_ID, conn);
    ...
    /** Load Constructor */
    public X_R_CategoryUpdates (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
