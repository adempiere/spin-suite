...
public class X_AD_LdapAccess extends PO implements I_AD_LdapAccess
{
    ...
    public X_AD_LdapAccess (Context ctx, int AD_LdapAccess_ID, DB conn)
    {
      super (ctx, AD_LdapAccess_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_LdapAccess (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_LdapAccess_ID (int AD_LdapAccess_ID)
	{
		if (AD_LdapAccess_ID < 1) 
			set_Value (COLUMNNAME_AD_LdapAccess_ID, null);
		else 
			set_Value (COLUMNNAME_AD_LdapAccess_ID, Integer.valueOf(AD_LdapAccess_ID));
	}
