...
public class X_R_InterestArea extends PO implements I_R_InterestArea
{
    ...
    public X_R_InterestArea (Context ctx, int R_InterestArea_ID, DB conn)
    {
      super (ctx, R_InterestArea_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_R_InterestArea (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
