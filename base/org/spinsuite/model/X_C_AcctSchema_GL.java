...
public class X_C_AcctSchema_GL extends PO implements I_C_AcctSchema_GL
{
    ...
    public X_C_AcctSchema_GL (Context ctx, int C_AcctSchema_GL_ID, DB conn)
    {
      super (ctx, C_AcctSchema_GL_ID, conn);
    ...
    /** Load Constructor */
    public X_C_AcctSchema_GL (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
