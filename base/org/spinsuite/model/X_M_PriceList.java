...
public class X_M_PriceList extends PO implements I_M_PriceList
{
    ...
    public X_M_PriceList (Context ctx, int M_PriceList_ID, DB conn)
    {
...
// 2
    ...
    /** Load Constructor */
    public X_M_PriceList (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
