...
public class X_A_Asset_Addition extends PO implements I_A_Asset_Addition
{
    ...
    public X_A_Asset_Addition (Context ctx, int A_Asset_Addition_ID, DB conn)
    {
      super (ctx, A_Asset_Addition_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Addition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
