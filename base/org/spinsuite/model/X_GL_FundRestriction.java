...
public class X_GL_FundRestriction extends PO implements I_GL_FundRestriction
{
    ...
    public X_GL_FundRestriction (Context ctx, int GL_FundRestriction_ID, DB conn)
    {
      super (ctx, GL_FundRestriction_ID, conn);
    ...
    /** Load Constructor */
    public X_GL_FundRestriction (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (GL_Fund_ID < 1) 
			set_Value (COLUMNNAME_GL_Fund_ID, null);
		else 
			set_Value (COLUMNNAME_GL_Fund_ID, Integer.valueOf(GL_Fund_ID));
	}
	...
	public void setGL_FundRestriction_ID (int GL_FundRestriction_ID)
	{
		if (GL_FundRestriction_ID < 1) 
			set_Value (COLUMNNAME_GL_FundRestriction_ID, null);
		else 
			set_Value (COLUMNNAME_GL_FundRestriction_ID, Integer.valueOf(GL_FundRestriction_ID));
	}
