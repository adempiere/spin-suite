...
public class X_C_BP_BankAccount extends PO implements I_C_BP_BankAccount
{
    ...
    public X_C_BP_BankAccount (Context ctx, int C_BP_BankAccount_ID, DB conn)
    {
      super (ctx, C_BP_BankAccount_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BP_BankAccount (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
