...
public class X_C_TaxGroup extends PO implements I_C_TaxGroup
{
    ...
    public X_C_TaxGroup (Context ctx, int C_TaxGroup_ID, DB conn)
    {
      super (ctx, C_TaxGroup_ID, conn);
      /** if (C_TaxGroup_ID == 0)
        {
			setC_TaxGroup_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_C_TaxGroup (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
