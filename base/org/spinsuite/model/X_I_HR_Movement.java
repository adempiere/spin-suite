...
public class X_I_HR_Movement extends PO implements I_I_HR_Movement
{
    ...
    public X_I_HR_Movement (Context ctx, int I_HR_Movement_ID, DB conn)
    {
      super (ctx, I_HR_Movement_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_I_HR_Movement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setI_HR_Movement_ID (int I_HR_Movement_ID)
	{
		if (I_HR_Movement_ID < 1) 
			set_Value (COLUMNNAME_I_HR_Movement_ID, null);
		else 
			set_Value (COLUMNNAME_I_HR_Movement_ID, Integer.valueOf(I_HR_Movement_ID));
	}
