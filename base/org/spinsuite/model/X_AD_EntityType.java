...
public class X_AD_EntityType extends PO implements I_AD_EntityType
{
    ...
    public X_AD_EntityType (Context ctx, int AD_EntityType_ID, DB conn)
    {
      super (ctx, AD_EntityType_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_EntityType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
