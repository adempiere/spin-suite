...
public class X_M_PromotionGroup extends PO implements I_M_PromotionGroup
{
    ...
    public X_M_PromotionGroup (Context ctx, int M_PromotionGroup_ID, DB conn)
    {
      super (ctx, M_PromotionGroup_ID, conn);
    ...
    /** Load Constructor */
    public X_M_PromotionGroup (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Get Promotion Group.
		@return Grouping of product for promotion setup
	  */
