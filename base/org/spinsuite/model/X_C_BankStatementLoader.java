...
public class X_C_BankStatementLoader extends PO implements I_C_BankStatementLoader
{
    ...
    public X_C_BankStatementLoader (Context ctx, int C_BankStatementLoader_ID, DB conn)
    {
      super (ctx, C_BankStatementLoader_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BankStatementLoader (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_BankStatementLoader_ID (int C_BankStatementLoader_ID)
	{
		if (C_BankStatementLoader_ID < 1) 
			set_Value (COLUMNNAME_C_BankStatementLoader_ID, null);
		else 
			set_Value (COLUMNNAME_C_BankStatementLoader_ID, Integer.valueOf(C_BankStatementLoader_ID));
	}
