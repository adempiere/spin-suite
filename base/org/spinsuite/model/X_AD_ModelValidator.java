...
public class X_AD_ModelValidator extends PO implements I_AD_ModelValidator
{
    ...
    public X_AD_ModelValidator (Context ctx, int AD_ModelValidator_ID, DB conn)
    {
      super (ctx, AD_ModelValidator_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_ModelValidator (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
