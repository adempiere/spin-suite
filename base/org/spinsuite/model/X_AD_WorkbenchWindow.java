...
public class X_AD_WorkbenchWindow extends PO implements I_AD_WorkbenchWindow
{
    ...
    public X_AD_WorkbenchWindow (Context ctx, int AD_WorkbenchWindow_ID, DB conn)
    {
      super (ctx, AD_WorkbenchWindow_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_WorkbenchWindow (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_WorkbenchWindow_ID (int AD_WorkbenchWindow_ID)
	{
		if (AD_WorkbenchWindow_ID < 1) 
			set_Value (COLUMNNAME_AD_WorkbenchWindow_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WorkbenchWindow_ID, Integer.valueOf(AD_WorkbenchWindow_ID));
	}
