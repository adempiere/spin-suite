...
public class X_AD_Table_Access extends PO implements I_AD_Table_Access
{
    ...
    public X_AD_Table_Access (Context ctx, int AD_Table_Access_ID, DB conn)
    {
      super (ctx, AD_Table_Access_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_AD_Table_Access (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAccessTypeRule (String AccessTypeRule)
	{
		...
		set_Value (COLUMNNAME_AccessTypeRule, AccessTypeRule);
	}
