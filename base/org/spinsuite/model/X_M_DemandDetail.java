...
public class X_M_DemandDetail extends PO implements I_M_DemandDetail
{
    ...
    public X_M_DemandDetail (Context ctx, int M_DemandDetail_ID, DB conn)
    {
      super (ctx, M_DemandDetail_ID, conn);
    ...
    /** Load Constructor */
    public X_M_DemandDetail (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setM_DemandDetail_ID (int M_DemandDetail_ID)
	{
		if (M_DemandDetail_ID < 1) 
			set_Value (COLUMNNAME_M_DemandDetail_ID, null);
		else 
			set_Value (COLUMNNAME_M_DemandDetail_ID, Integer.valueOf(M_DemandDetail_ID));
	}
