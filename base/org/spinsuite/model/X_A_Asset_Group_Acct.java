...
public class X_A_Asset_Group_Acct extends PO implements I_A_Asset_Group_Acct
{
    ...
    public X_A_Asset_Group_Acct (Context ctx, int A_Asset_Group_Acct_ID, DB conn)
    {
      super (ctx, A_Asset_Group_Acct_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Group_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Group_Acct_ID (int A_Asset_Group_Acct_ID)
	{
		if (A_Asset_Group_Acct_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Group_Acct_ID, null);
		else 
			set_Value (COLUMNNAME_A_Asset_Group_Acct_ID, Integer.valueOf(A_Asset_Group_Acct_ID));
	}
