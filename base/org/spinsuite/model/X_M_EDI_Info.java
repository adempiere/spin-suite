...
public class X_M_EDI_Info extends PO implements I_M_EDI_Info
{
    ...
    public X_M_EDI_Info (Context ctx, int M_EDI_Info_ID, DB conn)
    {
      super (ctx, M_EDI_Info_ID, conn);
      /** if (M_EDI_Info_ID == 0)
        {
			setInfo (null);
			setM_EDI_ID (0);
    ...
    /** Load Constructor */
    public X_M_EDI_Info (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (M_EDI_Info_ID < 1) 
			set_Value (COLUMNNAME_M_EDI_Info_ID, null);
		else 
			set_Value (COLUMNNAME_M_EDI_Info_ID, Integer.valueOf(M_EDI_Info_ID));
	}
