...
// N
    ...
    /** Load Constructor */
    public X_C_OrderTax (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Order Tax ID.
		@param C_OrderTax_ID Order Tax ID	  */
	public void setC_OrderTax_ID (int C_OrderTax_ID)
	{
		if (C_OrderTax_ID < 1) 
			set_Value (COLUMNNAME_C_OrderTax_ID, null);
		else 
			set_Value (COLUMNNAME_C_OrderTax_ID, Integer.valueOf(C_OrderTax_ID));
	}
