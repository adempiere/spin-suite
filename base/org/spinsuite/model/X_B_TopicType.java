...
public class X_B_TopicType extends PO implements I_B_TopicType
{
    ...
    public X_B_TopicType (Context ctx, int B_TopicType_ID, DB conn)
    {
      super (ctx, B_TopicType_ID, conn);
      /** if (B_TopicType_ID == 0)
        {
			setAuctionType (null);
			setB_TopicType_ID (0);
    ...
    /** Load Constructor */
    public X_B_TopicType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
