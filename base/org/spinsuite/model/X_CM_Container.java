...
public class X_CM_Container extends PO implements I_CM_Container
{
    ...
    public X_CM_Container (Context ctx, int CM_Container_ID, DB conn)
    {
      super (ctx, CM_Container_ID, conn);
...
// D
    ...
    /** Load Constructor */
    public X_CM_Container (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
