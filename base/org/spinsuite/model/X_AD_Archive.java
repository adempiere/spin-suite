...
public class X_AD_Archive extends PO implements I_AD_Archive
{
    ...
    public X_AD_Archive (Context ctx, int AD_Archive_ID, DB conn)
    {
      super (ctx, AD_Archive_ID, conn);
      /** if (AD_Archive_ID == 0)
        {
			setAD_Archive_ID (0);
			setBinaryData (null);
    ...
    /** Load Constructor */
    public X_AD_Archive (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
