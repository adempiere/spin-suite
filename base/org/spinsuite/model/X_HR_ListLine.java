...
public class X_HR_ListLine extends PO implements I_HR_ListLine
{
    ...
    public X_HR_ListLine (Context ctx, int HR_ListLine_ID, DB conn)
    {
      super (ctx, HR_ListLine_ID, conn);
      /** if (HR_ListLine_ID == 0)
        {
			setHR_ListLine_ID (0);
    ...
    /** Load Constructor */
    public X_HR_ListLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (HR_ListLine_ID < 1) 
			set_Value (COLUMNNAME_HR_ListLine_ID, null);
		else 
			set_Value (COLUMNNAME_HR_ListLine_ID, Integer.valueOf(HR_ListLine_ID));
	}
