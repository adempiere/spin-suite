...
public class X_PP_Cost_Collector extends PO implements I_PP_Cost_Collector
{
    ...
    public X_PP_Cost_Collector (Context ctx, int PP_Cost_Collector_ID, DB conn)
    {
      super (ctx, PP_Cost_Collector_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_PP_Cost_Collector (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
