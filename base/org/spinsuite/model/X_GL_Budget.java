...
public class X_GL_Budget extends PO implements I_GL_Budget
{
    ...
    public X_GL_Budget (Context ctx, int GL_Budget_ID, DB conn)
    {
      super (ctx, GL_Budget_ID, conn);
      /** if (GL_Budget_ID == 0)
        {
			setGL_Budget_ID (0);
			setIsPrimary (false);
    ...
    /** Load Constructor */
    public X_GL_Budget (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
