...
public class X_A_Asset_Change extends PO implements I_A_Asset_Change
{
    ...
    public X_A_Asset_Change (Context ctx, int A_Asset_Change_ID, DB conn)
    {
      super (ctx, A_Asset_Change_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Change (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Change_ID (int A_Asset_Change_ID)
	{
		if (A_Asset_Change_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Change_ID, null);
		else 
			set_Value (COLUMNNAME_A_Asset_Change_ID, Integer.valueOf(A_Asset_Change_ID));
	}
	...
	{
		set_Value (COLUMNNAME_AssetAccumDepreciationAmt, AssetAccumDepreciationAmt);
	}
	...
	{
		set_Value (COLUMNNAME_AssetBookValueAmt, AssetBookValueAmt);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_ChangeDate);
	}
