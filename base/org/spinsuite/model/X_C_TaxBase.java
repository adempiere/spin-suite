...
public class X_C_TaxBase extends PO implements I_C_TaxBase
{
    ...
    public X_C_TaxBase (Context ctx, int C_TaxBase_ID, DB conn)
    {
      super (ctx, C_TaxBase_ID, conn);
      /** if (C_TaxBase_ID == 0)
        {
			setC_TaxBase_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_C_TaxBase (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
