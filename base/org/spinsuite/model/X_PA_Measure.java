...
public class X_PA_Measure extends PO implements I_PA_Measure
{
    ...
    public X_PA_Measure (Context ctx, int PA_Measure_ID, DB conn)
    {
      super (ctx, PA_Measure_ID, conn);
      /** if (PA_Measure_ID == 0)
        {
...
// M
    ...
    /** Load Constructor */
    public X_PA_Measure (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
