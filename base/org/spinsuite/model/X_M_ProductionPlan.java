...
public class X_M_ProductionPlan extends PO implements I_M_ProductionPlan
{
    ...
    public X_M_ProductionPlan (Context ctx, int M_ProductionPlan_ID, DB conn)
    {
      super (ctx, M_ProductionPlan_ID, conn);
...
// 1
    ...
    /** Load Constructor */
    public X_M_ProductionPlan (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
