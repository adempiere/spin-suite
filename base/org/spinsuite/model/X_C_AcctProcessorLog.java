...
public class X_C_AcctProcessorLog extends PO implements I_C_AcctProcessorLog
{
    ...
    public X_C_AcctProcessorLog (Context ctx, int C_AcctProcessorLog_ID, DB conn)
    {
      super (ctx, C_AcctProcessorLog_ID, conn);
    ...
    /** Load Constructor */
    public X_C_AcctProcessorLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_AcctProcessor_ID (int C_AcctProcessor_ID)
	{
		if (C_AcctProcessor_ID < 1) 
			set_Value (COLUMNNAME_C_AcctProcessor_ID, null);
		else 
			set_Value (COLUMNNAME_C_AcctProcessor_ID, Integer.valueOf(C_AcctProcessor_ID));
	}
	...
	public void setC_AcctProcessorLog_ID (int C_AcctProcessorLog_ID)
	{
		if (C_AcctProcessorLog_ID < 1) 
			set_Value (COLUMNNAME_C_AcctProcessorLog_ID, null);
		else 
			set_Value (COLUMNNAME_C_AcctProcessorLog_ID, Integer.valueOf(C_AcctProcessorLog_ID));
	}
