...
public class X_C_PeriodControl extends PO implements I_C_PeriodControl
{
    ...
    public X_C_PeriodControl (Context ctx, int C_PeriodControl_ID, DB conn)
    {
      super (ctx, C_PeriodControl_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_PeriodControl (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_PeriodControl_ID (int C_PeriodControl_ID)
	{
		if (C_PeriodControl_ID < 1) 
			set_Value (COLUMNNAME_C_PeriodControl_ID, null);
		else 
			set_Value (COLUMNNAME_C_PeriodControl_ID, Integer.valueOf(C_PeriodControl_ID));
	}
