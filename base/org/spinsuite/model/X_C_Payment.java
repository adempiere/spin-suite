...
public class X_C_Payment extends PO implements I_C_Payment
{
    ...
    public X_C_Payment (Context ctx, int C_Payment_ID, DB conn)
    {
      super (ctx, C_Payment_ID, conn);
      /** if (C_Payment_ID == 0)
        {
			setC_Currency_ID (0);
			setC_DocType_ID (0);
...
// S
    ...
    /** Load Constructor */
    public X_C_Payment (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_R_AuthCode_DC, R_AuthCode_DC);
	}
	...
	{
		set_Value (COLUMNNAME_R_CVV2Match, Boolean.valueOf(R_CVV2Match));
	}
	...
	{
		set_Value (COLUMNNAME_R_PnRef_DC, R_PnRef_DC);
	}
