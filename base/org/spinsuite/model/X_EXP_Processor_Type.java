...
public class X_EXP_Processor_Type extends PO implements I_EXP_Processor_Type
{
    ...
    public X_EXP_Processor_Type (Context ctx, int EXP_Processor_Type_ID, DB conn)
    {
      super (ctx, EXP_Processor_Type_ID, conn);
    ...
    /** Load Constructor */
    public X_EXP_Processor_Type (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
