...
public class X_AD_LabelPrinterFunction extends PO implements I_AD_LabelPrinterFunction
{
    ...
    public X_AD_LabelPrinterFunction (Context ctx, int AD_LabelPrinterFunction_ID, DB conn)
    {
      super (ctx, AD_LabelPrinterFunction_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_LabelPrinterFunction (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
