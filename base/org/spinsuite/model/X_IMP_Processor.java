...
public class X_IMP_Processor extends PO implements I_IMP_Processor
{
    ...
    public X_IMP_Processor (Context ctx, int IMP_Processor_ID, DB conn)
    {
      super (ctx, IMP_Processor_ID, conn);
...
// 7
    ...
    /** Load Constructor */
    public X_IMP_Processor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
