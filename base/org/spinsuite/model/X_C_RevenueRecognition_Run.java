...
public class X_C_RevenueRecognition_Run extends PO implements I_C_RevenueRecognition_Run
{
    ...
    public X_C_RevenueRecognition_Run (Context ctx, int C_RevenueRecognition_Run_ID, DB conn)
    {
      super (ctx, C_RevenueRecognition_Run_ID, conn);
    ...
    /** Load Constructor */
    public X_C_RevenueRecognition_Run (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_RevenueRecognition_Run_ID (int C_RevenueRecognition_Run_ID)
	{
		if (C_RevenueRecognition_Run_ID < 1) 
			set_Value (COLUMNNAME_C_RevenueRecognition_Run_ID, null);
		else 
			set_Value (COLUMNNAME_C_RevenueRecognition_Run_ID, Integer.valueOf(C_RevenueRecognition_Run_ID));
	}
