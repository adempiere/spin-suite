...
public class X_Fact_Acct_Summary extends PO implements I_Fact_Acct_Summary
{
    ...
    public X_Fact_Acct_Summary (Context ctx, int Fact_Acct_Summary_ID, DB conn)
    {
      super (ctx, Fact_Acct_Summary_ID, conn);
    ...
    /** Load Constructor */
    public X_Fact_Acct_Summary (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
