...
public class X_IMP_ProcessorLog extends PO implements I_IMP_ProcessorLog
{
    ...
    public X_IMP_ProcessorLog (Context ctx, int IMP_ProcessorLog_ID, DB conn)
    {
      super (ctx, IMP_ProcessorLog_ID, conn);
...
// 'Y'
    ...
    /** Load Constructor */
    public X_IMP_ProcessorLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setIMP_ProcessorLog_ID (int IMP_ProcessorLog_ID)
	{
		if (IMP_ProcessorLog_ID < 1) 
			set_Value (COLUMNNAME_IMP_ProcessorLog_ID, null);
		else 
			set_Value (COLUMNNAME_IMP_ProcessorLog_ID, Integer.valueOf(IMP_ProcessorLog_ID));
	}
