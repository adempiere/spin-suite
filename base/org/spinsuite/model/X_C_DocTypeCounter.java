...
public class X_C_DocTypeCounter extends PO implements I_C_DocTypeCounter
{
    ...
    public X_C_DocTypeCounter (Context ctx, int C_DocTypeCounter_ID, DB conn)
    {
      super (ctx, C_DocTypeCounter_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_C_DocTypeCounter (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_DocTypeCounter_ID (int C_DocTypeCounter_ID)
	{
		if (C_DocTypeCounter_ID < 1) 
			set_Value (COLUMNNAME_C_DocTypeCounter_ID, null);
		else 
			set_Value (COLUMNNAME_C_DocTypeCounter_ID, Integer.valueOf(C_DocTypeCounter_ID));
	}
