...
public class X_AD_DesktopWorkbench extends PO implements I_AD_DesktopWorkbench
{
    ...
    public X_AD_DesktopWorkbench (Context ctx, int AD_DesktopWorkbench_ID, DB conn)
    {
      super (ctx, AD_DesktopWorkbench_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_DesktopWorkbench (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (AD_Desktop_ID < 1) 
			set_Value (COLUMNNAME_AD_Desktop_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Desktop_ID, Integer.valueOf(AD_Desktop_ID));
	}
	...
	public void setAD_DesktopWorkbench_ID (int AD_DesktopWorkbench_ID)
	{
		if (AD_DesktopWorkbench_ID < 1) 
			set_Value (COLUMNNAME_AD_DesktopWorkbench_ID, null);
		else 
			set_Value (COLUMNNAME_AD_DesktopWorkbench_ID, Integer.valueOf(AD_DesktopWorkbench_ID));
	}
