...
public class X_C_OrgAssignment extends PO implements I_C_OrgAssignment
{
    ...
    public X_C_OrgAssignment (Context ctx, int C_OrgAssignment_ID, DB conn)
    {
      super (ctx, C_OrgAssignment_ID, conn);
    ...
    /** Load Constructor */
    public X_C_OrgAssignment (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_OrgAssignment_ID (int C_OrgAssignment_ID)
	{
		if (C_OrgAssignment_ID < 1) 
			set_Value (COLUMNNAME_C_OrgAssignment_ID, null);
		else 
			set_Value (COLUMNNAME_C_OrgAssignment_ID, Integer.valueOf(C_OrgAssignment_ID));
	}
