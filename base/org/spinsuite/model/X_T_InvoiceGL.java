...
public class X_T_InvoiceGL extends PO implements I_T_InvoiceGL
{
    ...
    public X_T_InvoiceGL (Context ctx, int T_InvoiceGL_ID, DB conn)
    {
      super (ctx, T_InvoiceGL_ID, conn);
      /** if (T_InvoiceGL_ID == 0)
        {
			...
			setC_Invoice_ID (0);
			setDateReval (new Date( System.currentTimeMillis() ));
			setFact_Acct_ID (0);
    ...
    /** Load Constructor */
    public X_T_InvoiceGL (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Revaluation Date.
		...
		Date of Revaluation
	  */
	public void setDateReval (Date DateReval)
	{
	...
	/** Get Revaluation Date.
	  ...
	  */
	public Date getDateReval () 
	{
		return (Date)get_Value(COLUMNNAME_DateReval);
	}
