...
public class X_M_InventoryLineMA extends PO implements I_M_InventoryLineMA
{
    ...
    public X_M_InventoryLineMA (Context ctx, int M_InventoryLineMA_ID, DB conn)
    {
      super (ctx, M_InventoryLineMA_ID, conn);
    ...
    /** Load Constructor */
    public X_M_InventoryLineMA (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
