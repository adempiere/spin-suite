...
public class X_PP_Cost_CollectorMA extends PO implements I_PP_Cost_CollectorMA
{
    ...
    public X_PP_Cost_CollectorMA (Context ctx, int PP_Cost_CollectorMA_ID, DB conn)
    {
      super (ctx, PP_Cost_CollectorMA_ID, conn);
    ...
    /** Load Constructor */
    public X_PP_Cost_CollectorMA (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setPP_Cost_CollectorMA_ID (int PP_Cost_CollectorMA_ID)
	{
		if (PP_Cost_CollectorMA_ID < 1) 
			set_Value (COLUMNNAME_PP_Cost_CollectorMA_ID, null);
		else 
			set_Value (COLUMNNAME_PP_Cost_CollectorMA_ID, Integer.valueOf(PP_Cost_CollectorMA_ID));
	}
