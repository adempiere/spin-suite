...
public class X_PP_Order_BOM extends PO implements I_PP_Order_BOM
{
    ...
    public X_PP_Order_BOM (Context ctx, int PP_Order_BOM_ID, DB conn)
    {
      super (ctx, PP_Order_BOM_ID, conn);
    ...
    /** Load Constructor */
    public X_PP_Order_BOM (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
