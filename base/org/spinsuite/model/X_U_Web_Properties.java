...
public class X_U_Web_Properties extends PO implements I_U_Web_Properties
{
    ...
    public X_U_Web_Properties (Context ctx, int U_Web_Properties_ID, DB conn)
    {
      super (ctx, U_Web_Properties_ID, conn);
    ...
    /** Load Constructor */
    public X_U_Web_Properties (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setU_Web_Properties_ID (int U_Web_Properties_ID)
	{
		if (U_Web_Properties_ID < 1) 
			set_Value (COLUMNNAME_U_Web_Properties_ID, null);
		else 
			set_Value (COLUMNNAME_U_Web_Properties_ID, Integer.valueOf(U_Web_Properties_ID));
	}
