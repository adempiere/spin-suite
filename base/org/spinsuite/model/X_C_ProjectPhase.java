...
public class X_C_ProjectPhase extends PO implements I_C_ProjectPhase
{
    ...
    public X_C_ProjectPhase (Context ctx, int C_ProjectPhase_ID, DB conn)
    {
      super (ctx, C_ProjectPhase_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM C_ProjectPhase WHERE C_Project_ID=@C_Project_ID@
    ...
    /** Load Constructor */
    public X_C_ProjectPhase (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
