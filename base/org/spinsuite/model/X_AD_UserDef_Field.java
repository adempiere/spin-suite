...
public class X_AD_UserDef_Field extends PO implements I_AD_UserDef_Field
{
    ...
    public X_AD_UserDef_Field (Context ctx, int AD_UserDef_Field_ID, DB conn)
    {
      super (ctx, AD_UserDef_Field_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_UserDef_Field (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_UserDef_Field_ID (int AD_UserDef_Field_ID)
	{
		if (AD_UserDef_Field_ID < 1) 
			set_Value (COLUMNNAME_AD_UserDef_Field_ID, null);
		else 
			set_Value (COLUMNNAME_AD_UserDef_Field_ID, Integer.valueOf(AD_UserDef_Field_ID));
	}
