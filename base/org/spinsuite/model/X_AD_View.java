...
public class X_AD_View extends PO implements I_AD_View
{
    ...
    public X_AD_View (Context ctx, int AD_View_ID, DB conn)
    {
      super (ctx, AD_View_ID, conn);
      /** if (AD_View_ID == 0)
        {
			setAD_View_ID (0);
			setEntityType (null);
    ...
    /** Load Constructor */
    public X_AD_View (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
