...
public class X_HR_List extends PO implements I_HR_List
{
    ...
    public X_HR_List (Context ctx, int HR_List_ID, DB conn)
    {
      super (ctx, HR_List_ID, conn);
      /** if (HR_List_ID == 0)
        {
			setHR_List_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_List (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
