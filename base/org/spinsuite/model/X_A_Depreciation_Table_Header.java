...
public class X_A_Depreciation_Table_Header extends PO implements I_A_Depreciation_Table_Header
{
    ...
    public X_A_Depreciation_Table_Header (Context ctx, int A_Depreciation_Table_Header_ID, DB conn)
    {
      super (ctx, A_Depreciation_Table_Header_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Table_Header (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
