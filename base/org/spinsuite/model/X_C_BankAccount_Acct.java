...
public class X_C_BankAccount_Acct extends PO implements I_C_BankAccount_Acct
{
    ...
    public X_C_BankAccount_Acct (Context ctx, int C_BankAccount_Acct_ID, DB conn)
    {
      super (ctx, C_BankAccount_Acct_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BankAccount_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
