...
public class X_HR_Movement extends PO implements I_HR_Movement
{
    ...
    public X_HR_Movement (Context ctx, int HR_Movement_ID, DB conn)
    {
      super (ctx, HR_Movement_ID, conn);
      /** if (HR_Movement_ID == 0)
        {
			setHR_Concept_ID (0);
			setHR_Movement_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Movement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
