...
public class X_AD_Menu extends PO implements I_AD_Menu
{
    ...
    public X_AD_Menu (Context ctx, int AD_Menu_ID, DB conn)
    {
      super (ctx, AD_Menu_ID, conn);
      /** if (AD_Menu_ID == 0)
        {
			setAD_Menu_ID (0);
			setEntityType (null);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Menu (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
