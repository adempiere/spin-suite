...
public class X_M_Demand extends PO implements I_M_Demand
{
    ...
    public X_M_Demand (Context ctx, int M_Demand_ID, DB conn)
    {
      super (ctx, M_Demand_ID, conn);
      /** if (M_Demand_ID == 0)
        {
			setC_Calendar_ID (0);
			setC_Year_ID (0);
    ...
    /** Load Constructor */
    public X_M_Demand (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
