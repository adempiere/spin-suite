...
public class X_HR_Job extends PO implements I_HR_Job
{
    ...
    public X_HR_Job (Context ctx, int HR_Job_ID, DB conn)
    {
      super (ctx, HR_Job_ID, conn);
      /** if (HR_Job_ID == 0)
        {
			setHR_Job_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Job (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
