...
public class X_A_Asset_Info_Lic extends PO implements I_A_Asset_Info_Lic
{
    ...
    public X_A_Asset_Info_Lic (Context ctx, int A_Asset_Info_Lic_ID, DB conn)
    {
      super (ctx, A_Asset_Info_Lic_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Info_Lic (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Info_Lic_ID (int A_Asset_Info_Lic_ID)
	{
		if (A_Asset_Info_Lic_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Info_Lic_ID, null);
		else 
