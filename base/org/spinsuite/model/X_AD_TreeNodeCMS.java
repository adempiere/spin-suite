...
public class X_AD_TreeNodeCMS extends PO implements I_AD_TreeNodeCMS
{
    ...
    public X_AD_TreeNodeCMS (Context ctx, int AD_TreeNodeCMS_ID, DB conn)
    {
      super (ctx, AD_TreeNodeCMS_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeCMS (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
