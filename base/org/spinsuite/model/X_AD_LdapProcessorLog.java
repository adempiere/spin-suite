...
public class X_AD_LdapProcessorLog extends PO implements I_AD_LdapProcessorLog
{
    ...
    public X_AD_LdapProcessorLog (Context ctx, int AD_LdapProcessorLog_ID, DB conn)
    {
      super (ctx, AD_LdapProcessorLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_LdapProcessorLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_LdapProcessor_ID (int AD_LdapProcessor_ID)
	{
		if (AD_LdapProcessor_ID < 1) 
			set_Value (COLUMNNAME_AD_LdapProcessor_ID, null);
		else 
			set_Value (COLUMNNAME_AD_LdapProcessor_ID, Integer.valueOf(AD_LdapProcessor_ID));
	}
	...
	public void setAD_LdapProcessorLog_ID (int AD_LdapProcessorLog_ID)
	{
		if (AD_LdapProcessorLog_ID < 1) 
			set_Value (COLUMNNAME_AD_LdapProcessorLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_LdapProcessorLog_ID, Integer.valueOf(AD_LdapProcessorLog_ID));
	}
