...
public class X_AD_UserBPAccess extends PO implements I_AD_UserBPAccess
{
    ...
    public X_AD_UserBPAccess (Context ctx, int AD_UserBPAccess_ID, DB conn)
    {
      super (ctx, AD_UserBPAccess_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_UserBPAccess (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_UserBPAccess_ID (int AD_UserBPAccess_ID)
	{
		if (AD_UserBPAccess_ID < 1) 
			set_Value (COLUMNNAME_AD_UserBPAccess_ID, null);
		else 
			set_Value (COLUMNNAME_AD_UserBPAccess_ID, Integer.valueOf(AD_UserBPAccess_ID));
	}
