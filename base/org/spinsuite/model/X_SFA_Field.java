...
public class X_SFA_Field extends PO implements I_SFA_Field, I_Persistent 
{
    ...
    public X_SFA_Field (Context ctx, int SFA_Field_ID, DB conn)
    {
...
// ECA01
    ...
    /** Load Constructor */
    public X_SFA_Field (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (SFA_Field_ID < 1) 
			set_Value (COLUMNNAME_SFA_Field_ID, null);
		else 
			set_Value (COLUMNNAME_SFA_Field_ID, Integer.valueOf(SFA_Field_ID));
	}
