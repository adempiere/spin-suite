...
public class X_M_Attribute extends PO implements I_M_Attribute
{
    ...
    public X_M_Attribute (Context ctx, int M_Attribute_ID, DB conn)
    {
      super (ctx, M_Attribute_ID, conn);
      /** if (M_Attribute_ID == 0)
        {
...
// S
    ...
    /** Load Constructor */
    public X_M_Attribute (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
