...
public class X_AD_PrintLabelLine extends PO implements I_AD_PrintLabelLine
{
    ...
    public X_AD_PrintLabelLine (Context ctx, int AD_PrintLabelLine_ID, DB conn)
    {
      super (ctx, AD_PrintLabelLine_ID, conn);
...
// F
    ...
    /** Load Constructor */
    public X_AD_PrintLabelLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_PrintLabel_ID (int AD_PrintLabel_ID)
	{
		if (AD_PrintLabel_ID < 1) 
			set_Value (COLUMNNAME_AD_PrintLabel_ID, null);
		else 
			set_Value (COLUMNNAME_AD_PrintLabel_ID, Integer.valueOf(AD_PrintLabel_ID));
	}
	...
	public void setAD_PrintLabelLine_ID (int AD_PrintLabelLine_ID)
	{
		if (AD_PrintLabelLine_ID < 1) 
			set_Value (COLUMNNAME_AD_PrintLabelLine_ID, null);
		else 
			set_Value (COLUMNNAME_AD_PrintLabelLine_ID, Integer.valueOf(AD_PrintLabelLine_ID));
	}
