...
public class X_CM_AccessStage extends PO implements I_CM_AccessStage
{
    ...
    public X_CM_AccessStage (Context ctx, int CM_AccessStage_ID, DB conn)
    {
      super (ctx, CM_AccessStage_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_AccessStage (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
