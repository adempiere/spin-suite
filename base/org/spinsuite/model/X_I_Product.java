...
public class X_I_Product extends PO implements I_I_Product
{
    ...
    public X_I_Product (Context ctx, int I_Product_ID, DB conn)
    {
      super (ctx, I_Product_ID, conn);
      /** if (I_Product_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_I_Product (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DiscontinuedAt);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DiscontinuedBy);
	}
	...
	{
		if (I_Product_ID < 1) 
			set_Value (COLUMNNAME_I_Product_ID, null);
		else 
			set_Value (COLUMNNAME_I_Product_ID, Integer.valueOf(I_Product_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_PriceEffective);
	}
