...
public class X_CM_Template extends PO implements I_CM_Template
{
    ...
    public X_CM_Template (Context ctx, int CM_Template_ID, DB conn)
    {
      super (ctx, CM_Template_ID, conn);
      /** if (CM_Template_ID == 0)
        {
			setCM_Template_ID (0);
			setIsInclude (false);
    ...
    /** Load Constructor */
    public X_CM_Template (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
