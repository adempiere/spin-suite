...
public class X_A_Depreciation_Method extends PO implements I_A_Depreciation_Method
{
    ...
    public X_A_Depreciation_Method (Context ctx, int A_Depreciation_Method_ID, DB conn)
    {
      super (ctx, A_Depreciation_Method_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_A_Depreciation_Method (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
