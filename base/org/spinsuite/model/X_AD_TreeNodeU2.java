...
public class X_AD_TreeNodeU2 extends PO implements I_AD_TreeNodeU2
{
    ...
    public X_AD_TreeNodeU2 (Context ctx, int AD_TreeNodeU2_ID, DB conn)
    {
      super (ctx, AD_TreeNodeU2_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeU2 (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
