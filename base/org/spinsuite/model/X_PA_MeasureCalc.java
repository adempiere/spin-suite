...
public class X_PA_MeasureCalc extends PO implements I_PA_MeasureCalc
{
    ...
    public X_PA_MeasureCalc (Context ctx, int PA_MeasureCalc_ID, DB conn)
    {
      super (ctx, PA_MeasureCalc_ID, conn);
...
// WHERE ...
    ...
    /** Load Constructor */
    public X_PA_MeasureCalc (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
