...
public class X_AD_LabelPrinter extends PO implements I_AD_LabelPrinter
{
    ...
    public X_AD_LabelPrinter (Context ctx, int AD_LabelPrinter_ID, DB conn)
    {
      super (ctx, AD_LabelPrinter_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_LabelPrinter (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
