...
public class X_K_Type extends PO implements I_K_Type
{
    ...
    public X_K_Type (Context ctx, int K_Type_ID, DB conn)
    {
      super (ctx, K_Type_ID, conn);
      /** if (K_Type_ID == 0)
        {
			setIsPublic (true);
// Y
...
// Y
    ...
    /** Load Constructor */
    public X_K_Type (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
