...
public class X_AD_Process_Para extends PO implements I_AD_Process_Para {
    /** Standard Constructor */
    public X_AD_Process_Para (Context ctx, int AD_Process_Para_ID, DB conn)
    {
      super (ctx, AD_Process_Para_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Process_Para WHERE AD_Process_ID=@AD_Process_ID@
    ...
    /** Load Constructor */
    public X_AD_Process_Para (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
