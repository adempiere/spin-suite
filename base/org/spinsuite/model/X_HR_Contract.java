...
public class X_HR_Contract extends PO implements I_HR_Contract
{
    ...
    public X_HR_Contract (Context ctx, int HR_Contract_ID, DB conn)
    {
      super (ctx, HR_Contract_ID, conn);
      /** if (HR_Contract_ID == 0)
        {
			setHR_Contract_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Contract (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
