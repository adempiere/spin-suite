...
public class X_M_RMALine extends PO implements I_M_RMALine
{
    ...
    public X_M_RMALine (Context ctx, int M_RMALine_ID, DB conn)
    {
    ...
    /** Load Constructor */
    public X_M_RMALine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
