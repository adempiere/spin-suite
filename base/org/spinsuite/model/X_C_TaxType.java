...
public class X_C_TaxType extends PO implements I_C_TaxType
{
    ...
    public X_C_TaxType (Context ctx, int C_TaxType_ID, DB conn)
    {
      super (ctx, C_TaxType_ID, conn);
      /** if (C_TaxType_ID == 0)
        {
			setC_TaxType_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_C_TaxType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
