...
public class X_PA_ReportSource extends PO implements I_PA_ReportSource
{
    ...
    public X_PA_ReportSource (Context ctx, int PA_ReportSource_ID, DB conn)
    {
      super (ctx, PA_ReportSource_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_PA_ReportSource (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
