...
public class X_CM_WebProject extends PO implements I_CM_WebProject
{
    ...
    public X_CM_WebProject (Context ctx, int CM_WebProject_ID, DB conn)
    {
      super (ctx, CM_WebProject_ID, conn);
...
// 'INDEX,FOLLOW'
    ...
    /** Load Constructor */
    public X_CM_WebProject (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (AD_TreeCMC_ID < 1) 
			set_Value (COLUMNNAME_AD_TreeCMC_ID, null);
		else 
			set_Value (COLUMNNAME_AD_TreeCMC_ID, Integer.valueOf(AD_TreeCMC_ID));
	}
	...
	{
		if (AD_TreeCMM_ID < 1) 
			set_Value (COLUMNNAME_AD_TreeCMM_ID, null);
		else 
			set_Value (COLUMNNAME_AD_TreeCMM_ID, Integer.valueOf(AD_TreeCMM_ID));
	}
	...
	{
		if (AD_TreeCMS_ID < 1) 
			set_Value (COLUMNNAME_AD_TreeCMS_ID, null);
		else 
			set_Value (COLUMNNAME_AD_TreeCMS_ID, Integer.valueOf(AD_TreeCMS_ID));
	}
	...
	{
		if (AD_TreeCMT_ID < 1) 
			set_Value (COLUMNNAME_AD_TreeCMT_ID, null);
		else 
			set_Value (COLUMNNAME_AD_TreeCMT_ID, Integer.valueOf(AD_TreeCMT_ID));
	}
