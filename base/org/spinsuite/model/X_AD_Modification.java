...
public class X_AD_Modification extends PO implements I_AD_Modification
{
    ...
    public X_AD_Modification (Context ctx, int AD_Modification_ID, DB conn)
    {
      super (ctx, AD_Modification_ID, conn);
...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Modification WHERE EntityType='@EntityType@'
    ...
    /** Load Constructor */
    public X_AD_Modification (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Modification.
		@param AD_Modification_ID Modification	  */
	public void setAD_Modification_ID (int AD_Modification_ID)
	{
		if (AD_Modification_ID < 1) 
			set_Value (COLUMNNAME_AD_Modification_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Modification_ID, Integer.valueOf(AD_Modification_ID));
	}
