...
public class X_AD_Role_Included extends PO implements I_AD_Role_Included
{
    ...
    public X_AD_Role_Included (Context ctx, int AD_Role_Included_ID, DB conn)
    {
      super (ctx, AD_Role_Included_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Role_Included WHERE AD_Role_ID=@AD_Role_ID@
    ...
    /** Load Constructor */
    public X_AD_Role_Included (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
