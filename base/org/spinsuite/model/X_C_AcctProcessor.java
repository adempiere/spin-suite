...
public class X_C_AcctProcessor extends PO implements I_C_AcctProcessor
{
    ...
    public X_C_AcctProcessor (Context ctx, int C_AcctProcessor_ID, DB conn)
    {
      super (ctx, C_AcctProcessor_ID, conn);
...
// 7
    ...
    /** Load Constructor */
    public X_C_AcctProcessor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
