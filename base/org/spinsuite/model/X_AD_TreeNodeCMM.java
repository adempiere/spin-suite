...
public class X_AD_TreeNodeCMM extends PO implements I_AD_TreeNodeCMM
{
    ...
    public X_AD_TreeNodeCMM (Context ctx, int AD_TreeNodeCMM_ID, DB conn)
    {
      super (ctx, AD_TreeNodeCMM_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeCMM (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
