...
public class X_GL_Category extends PO implements I_GL_Category
{
    ...
    public X_GL_Category (Context ctx, int GL_Category_ID, DB conn)
    {
      super (ctx, GL_Category_ID, conn);
      /** if (GL_Category_ID == 0)
        {
...
// M
    ...
    /** Load Constructor */
    public X_GL_Category (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
