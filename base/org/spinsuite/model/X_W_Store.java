...
public class X_W_Store extends PO implements I_W_Store
{
    ...
    public X_W_Store (Context ctx, int W_Store_ID, DB conn)
    {
      super (ctx, W_Store_ID, conn);
      /** if (W_Store_ID == 0)
        {
...
// Y
    ...
    /** Load Constructor */
    public X_W_Store (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
