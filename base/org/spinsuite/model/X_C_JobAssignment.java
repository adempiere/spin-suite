...
public class X_C_JobAssignment extends PO implements I_C_JobAssignment
{
    ...
    public X_C_JobAssignment (Context ctx, int C_JobAssignment_ID, DB conn)
    {
      super (ctx, C_JobAssignment_ID, conn);
    ...
    /** Load Constructor */
    public X_C_JobAssignment (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Position Assignment.
		@param C_JobAssignment_ID Position Assignment	  */
	public void setC_JobAssignment_ID (int C_JobAssignment_ID)
	{
		if (C_JobAssignment_ID < 1) 
			set_Value (COLUMNNAME_C_JobAssignment_ID, null);
		else 
			set_Value (COLUMNNAME_C_JobAssignment_ID, Integer.valueOf(C_JobAssignment_ID));
	}
