...
public class X_A_Depreciation_Build extends PO implements I_A_Depreciation_Build
{
    ...
    public X_A_Depreciation_Build (Context ctx, int A_Depreciation_Build_ID, DB conn)
    {
      super (ctx, A_Depreciation_Build_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Build (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Depreciation_Build_ID (int A_Depreciation_Build_ID)
	{
		if (A_Depreciation_Build_ID < 1) 
			set_Value (COLUMNNAME_A_Depreciation_Build_ID, null);
		else 
