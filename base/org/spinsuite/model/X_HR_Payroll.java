...
public class X_HR_Payroll extends PO implements I_HR_Payroll
{
    ...
    public X_HR_Payroll (Context ctx, int HR_Payroll_ID, DB conn)
    {
      super (ctx, HR_Payroll_ID, conn);
      /** if (HR_Payroll_ID == 0)
        {
			setC_Charge_ID (0);
			setHR_Contract_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Payroll (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
