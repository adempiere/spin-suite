...
public class X_C_Job extends PO implements I_C_Job
{
    ...
    public X_C_Job (Context ctx, int C_Job_ID, DB conn)
    {
      super (ctx, C_Job_ID, conn);
      /** if (C_Job_ID == 0)
        {
...
// Y
    ...
    /** Load Constructor */
    public X_C_Job (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
