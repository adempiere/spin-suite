...
public class X_S_ExpenseType extends PO implements I_S_ExpenseType
{
    ...
    public X_S_ExpenseType (Context ctx, int S_ExpenseType_ID, DB conn)
    {
      super (ctx, S_ExpenseType_ID, conn);
    ...
    /** Load Constructor */
    public X_S_ExpenseType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
