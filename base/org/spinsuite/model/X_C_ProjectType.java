...
public class X_C_ProjectType extends PO implements I_C_ProjectType
{
    ...
    public X_C_ProjectType (Context ctx, int C_ProjectType_ID, DB conn)
    {
      super (ctx, C_ProjectType_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_ProjectType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
