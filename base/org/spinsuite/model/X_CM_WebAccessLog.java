...
public class X_CM_WebAccessLog extends PO implements I_CM_WebAccessLog
{
    ...
    public X_CM_WebAccessLog (Context ctx, int CM_WebAccessLog_ID, DB conn)
    {
      super (ctx, CM_WebAccessLog_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_WebAccessLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Web Access Log.
		@param CM_WebAccessLog_ID Web Access Log	  */
	public void setCM_WebAccessLog_ID (int CM_WebAccessLog_ID)
	{
		if (CM_WebAccessLog_ID < 1) 
			set_Value (COLUMNNAME_CM_WebAccessLog_ID, null);
		else 
			set_Value (COLUMNNAME_CM_WebAccessLog_ID, Integer.valueOf(CM_WebAccessLog_ID));
	}
