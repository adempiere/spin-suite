...
public class X_AD_Color extends PO implements I_AD_Color
{
    ...
    public X_AD_Color (Context ctx, int AD_Color_ID, DB conn)
    {
      super (ctx, AD_Color_ID, conn);
      /** if (AD_Color_ID == 0)
        {
			setAD_Color_ID (0);
			setAlpha (0);
    ...
    /** Load Constructor */
    public X_AD_Color (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
