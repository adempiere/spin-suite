...
public class X_A_RegistrationAttribute extends PO implements I_A_RegistrationAttribute
{
    ...
    public X_A_RegistrationAttribute (Context ctx, int A_RegistrationAttribute_ID, DB conn)
    {
      super (ctx, A_RegistrationAttribute_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_A_RegistrationAttribute (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
