...
public class X_A_Asset_Spread extends PO implements I_A_Asset_Spread
{
    ...
    public X_A_Asset_Spread (Context ctx, int A_Asset_Spread_ID, DB conn)
    {
      super (ctx, A_Asset_Spread_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Spread (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
