...
public class X_A_Depreciation_Entry extends PO implements I_A_Depreciation_Entry
{
    ...
    public X_A_Depreciation_Entry (Context ctx, int A_Depreciation_Entry_ID, DB conn)
    {
      super (ctx, A_Depreciation_Entry_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_A_Depreciation_Entry (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
