...
public class X_AD_SearchDefinition extends PO implements I_AD_SearchDefinition
{
    ...
    public X_AD_SearchDefinition (Context ctx, int AD_SearchDefinition_ID, DB conn)
    {
      super (ctx, AD_SearchDefinition_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_AD_SearchDefinition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_SearchDefinition_ID (int AD_SearchDefinition_ID)
	{
		if (AD_SearchDefinition_ID < 1) 
			set_Value (COLUMNNAME_AD_SearchDefinition_ID, null);
		else 
			set_Value (COLUMNNAME_AD_SearchDefinition_ID, Integer.valueOf(AD_SearchDefinition_ID));
	}
