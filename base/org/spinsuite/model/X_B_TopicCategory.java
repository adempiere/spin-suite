...
public class X_B_TopicCategory extends PO implements I_B_TopicCategory
{
    ...
    public X_B_TopicCategory (Context ctx, int B_TopicCategory_ID, DB conn)
    {
      super (ctx, B_TopicCategory_ID, conn);
    ...
    /** Load Constructor */
    public X_B_TopicCategory (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
