...
public class X_R_Request extends PO implements I_R_Request
{
    ...
    public X_R_Request (Context ctx, int R_Request_ID, DB conn)
    {
      super (ctx, R_Request_ID, conn);
      /** if (R_Request_ID == 0)
        {
...
// 5
    ...
    /** Load Constructor */
    public X_R_Request (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_InvoiceRequest_ID (int C_InvoiceRequest_ID)
	{
		if (C_InvoiceRequest_ID < 1) 
			set_Value (COLUMNNAME_C_InvoiceRequest_ID, null);
		else 
			set_Value (COLUMNNAME_C_InvoiceRequest_ID, Integer.valueOf(C_InvoiceRequest_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_CloseDate);
	}
	...
	/** Set Complete Plan.
	  ...
	  */
	public void setDateCompletePlan (Date DateCompletePlan)
	{
	...
	/** Get Complete Plan.
	  ...
	  */
	public Date getDateCompletePlan () 
	{
		return (Date)get_Value(COLUMNNAME_DateCompletePlan);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateLastAction);
	}
	...
	/** Set Last Alert.
	  ...
	  */
	public void setDateLastAlert (Date DateLastAlert)
	{
	...
	/** Get Last Alert.
	  ...
	  */
	public Date getDateLastAlert () 
	{
		return (Date)get_Value(COLUMNNAME_DateLastAlert);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateNextAction);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateStartPlan);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_EndTime);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_StartTime);
	}
