...
public class X_PA_ColorSchema extends PO implements I_PA_ColorSchema
{
    ...
    public X_PA_ColorSchema (Context ctx, int PA_ColorSchema_ID, DB conn)
    {
      super (ctx, PA_ColorSchema_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_PA_ColorSchema (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
