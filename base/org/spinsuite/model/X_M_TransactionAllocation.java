...
public class X_M_TransactionAllocation extends PO implements I_M_TransactionAllocation
{
    ...
    public X_M_TransactionAllocation (Context ctx, int M_TransactionAllocation_ID, DB conn)
    {
      super (ctx, M_TransactionAllocation_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_M_TransactionAllocation (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
