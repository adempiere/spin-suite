...
public class X_W_ClickCount extends PO implements I_W_ClickCount
{
    ...
    public X_W_ClickCount (Context ctx, int W_ClickCount_ID, DB conn)
    {
      super (ctx, W_ClickCount_ID, conn);
    ...
    /** Load Constructor */
    public X_W_ClickCount (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
