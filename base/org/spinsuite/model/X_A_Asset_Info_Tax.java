...
public class X_A_Asset_Info_Tax extends PO implements I_A_Asset_Info_Tax
{
    ...
    public X_A_Asset_Info_Tax (Context ctx, int A_Asset_Info_Tax_ID, DB conn)
    {
      super (ctx, A_Asset_Info_Tax_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Info_Tax (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Info_Tax_ID (int A_Asset_Info_Tax_ID)
	{
		if (A_Asset_Info_Tax_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Info_Tax_ID, null);
		else 
