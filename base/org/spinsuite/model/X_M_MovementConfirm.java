...
public class X_M_MovementConfirm extends PO implements I_M_MovementConfirm
{
    ...
    public X_M_MovementConfirm (Context ctx, int M_MovementConfirm_ID, DB conn)
    {
      super (ctx, M_MovementConfirm_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_M_MovementConfirm (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
