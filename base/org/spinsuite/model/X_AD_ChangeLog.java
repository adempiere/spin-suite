...
public class X_AD_ChangeLog extends PO implements I_AD_ChangeLog
{
    ...
    public X_AD_ChangeLog (Context ctx, int AD_ChangeLog_ID, DB conn)
    {
      super (ctx, AD_ChangeLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_ChangeLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_ChangeLog_ID (int AD_ChangeLog_ID)
	{
		if (AD_ChangeLog_ID < 1) 
			set_Value (COLUMNNAME_AD_ChangeLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_ChangeLog_ID, Integer.valueOf(AD_ChangeLog_ID));
	}
