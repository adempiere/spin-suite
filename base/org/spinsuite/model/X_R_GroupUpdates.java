...
public class X_R_GroupUpdates extends PO implements I_R_GroupUpdates
{
    ...
    public X_R_GroupUpdates (Context ctx, int R_GroupUpdates_ID, DB conn)
    {
      super (ctx, R_GroupUpdates_ID, conn);
    ...
    /** Load Constructor */
    public X_R_GroupUpdates (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
