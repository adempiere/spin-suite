...
public class X_AD_Alert extends PO implements I_AD_Alert
{
    ...
    public X_AD_Alert (Context ctx, int AD_Alert_ID, DB conn)
    {
      super (ctx, AD_Alert_ID, conn);
      /** if (AD_Alert_ID == 0)
        {
			setAD_Alert_ID (0);
...
// Y
    ...
    /** Load Constructor */
    public X_AD_Alert (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
