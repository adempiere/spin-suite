...
public class X_C_InvoiceBatchLine extends PO implements I_C_InvoiceBatchLine
{
    ...
    public X_C_InvoiceBatchLine (Context ctx, int C_InvoiceBatchLine_ID, DB conn)
    {
      super (ctx, C_InvoiceBatchLine_ID, conn);
...
// @DateAcct@;@DateDoc@
			setDateInvoiced (new Date( System.currentTimeMillis() ));
...
// 1
    ...
    /** Load Constructor */
    public X_C_InvoiceBatchLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_InvoiceBatch_ID (int C_InvoiceBatch_ID)
	{
		if (C_InvoiceBatch_ID < 1) 
			set_Value (COLUMNNAME_C_InvoiceBatch_ID, null);
		else 
			set_Value (COLUMNNAME_C_InvoiceBatch_ID, Integer.valueOf(C_InvoiceBatch_ID));
	}
	...
	public void setC_InvoiceBatchLine_ID (int C_InvoiceBatchLine_ID)
	{
		if (C_InvoiceBatchLine_ID < 1) 
			set_Value (COLUMNNAME_C_InvoiceBatchLine_ID, null);
		else 
			set_Value (COLUMNNAME_C_InvoiceBatchLine_ID, Integer.valueOf(C_InvoiceBatchLine_ID));
	}
