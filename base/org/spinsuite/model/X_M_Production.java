...
public class X_M_Production extends PO implements I_M_Production
{
    ...
    public X_M_Production (Context ctx, int M_Production_ID, DB conn)
    {
      super (ctx, M_Production_ID, conn);
...
// @#Date@
    ...
    /** Load Constructor */
    public X_M_Production (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
