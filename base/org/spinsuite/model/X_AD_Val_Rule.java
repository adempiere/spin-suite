...
public class X_AD_Val_Rule extends PO implements I_AD_Val_Rule {
    /** Standard Constructor */
    public X_AD_Val_Rule (Context ctx, int AD_Val_Rule_ID, DB conn)
    {
      super (ctx, AD_Val_Rule_ID, conn);
      /** if (AD_Val_Rule_ID == 0)
        {
			setAD_Val_Rule_ID (0);
			setEntityType (null);
// U
    ...
    /** Load Constructor */
    public X_AD_Val_Rule (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
