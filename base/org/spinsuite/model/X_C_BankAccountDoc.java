...
public class X_C_BankAccountDoc extends PO implements I_C_BankAccountDoc
{
    ...
    public X_C_BankAccountDoc (Context ctx, int C_BankAccountDoc_ID, DB conn)
    {
      super (ctx, C_BankAccountDoc_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BankAccountDoc (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
