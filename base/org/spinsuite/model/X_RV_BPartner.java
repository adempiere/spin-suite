...
public class X_RV_BPartner extends PO implements I_RV_BPartner
{
    ...
    public X_RV_BPartner (Context ctx, int RV_BPartner_ID, DB conn)
    {
      super (ctx, RV_BPartner_ID, conn);
      /** if (RV_BPartner_ID == 0)
        {
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_RV_BPartner (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_Birthday);
	}
	...
	{
		set_Value (COLUMNNAME_BPContactGreeting, Integer.valueOf(BPContactGreeting));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_EMailVerifyDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_FirstSale);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_LastContact);
	}
	...
	{
		set_Value (COLUMNNAME_LDAPUser, Boolean.valueOf(LDAPUser));
	}
	...
	{
		set_Value (COLUMNNAME_SO_CreditAvailable, SO_CreditAvailable);
	}
