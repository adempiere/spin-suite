...
public class X_AD_ReplicationDocument extends PO implements I_AD_ReplicationDocument
{
    ...
    public X_AD_ReplicationDocument (Context ctx, int AD_ReplicationDocument_ID, DB conn)
    {
      super (ctx, AD_ReplicationDocument_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_ReplicationDocument (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_ReplicationDocument_ID (int AD_ReplicationDocument_ID)
	{
		if (AD_ReplicationDocument_ID < 1) 
			set_Value (COLUMNNAME_AD_ReplicationDocument_ID, null);
		else 
			set_Value (COLUMNNAME_AD_ReplicationDocument_ID, Integer.valueOf(AD_ReplicationDocument_ID));
	}
