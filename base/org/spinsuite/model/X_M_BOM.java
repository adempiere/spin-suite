...
public class X_M_BOM extends PO implements I_M_BOM
{
    ...
    public X_M_BOM (Context ctx, int M_BOM_ID, DB conn)
    {
      super (ctx, M_BOM_ID, conn);
      /** if (M_BOM_ID == 0)
        {
			setBOMType (null);
// A
...
// A
    ...
    /** Load Constructor */
    public X_M_BOM (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
