...
public class X_AD_ReplicationTable extends PO implements I_AD_ReplicationTable
{
    ...
    public X_AD_ReplicationTable (Context ctx, int AD_ReplicationTable_ID, DB conn)
    {
      super (ctx, AD_ReplicationTable_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_ReplicationTable (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
