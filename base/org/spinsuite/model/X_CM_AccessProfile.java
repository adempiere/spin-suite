...
public class X_CM_AccessProfile extends PO implements I_CM_AccessProfile
{
    ...
    public X_CM_AccessProfile (Context ctx, int CM_AccessProfile_ID, DB conn)
    {
      super (ctx, CM_AccessProfile_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_CM_AccessProfile (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
