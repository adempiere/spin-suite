...
public class X_AD_TreeNodeU3 extends PO implements I_AD_TreeNodeU3
{
    ...
    public X_AD_TreeNodeU3 (Context ctx, int AD_TreeNodeU3_ID, DB conn)
    {
      super (ctx, AD_TreeNodeU3_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeU3 (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
