...
public class X_AD_PrintFormat extends PO implements I_AD_PrintFormat {
    /** Standard Constructor */
    public X_AD_PrintFormat (Context ctx, int AD_PrintFormat_ID, DB conn)
    {
      super (ctx, AD_PrintFormat_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_AD_PrintFormat (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_IsTableBased, Boolean.valueOf(IsTableBased));
	}
