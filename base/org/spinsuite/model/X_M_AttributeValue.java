...
public class X_M_AttributeValue extends PO implements I_M_AttributeValue
{
    ...
    public X_M_AttributeValue (Context ctx, int M_AttributeValue_ID, DB conn)
    {
      super (ctx, M_AttributeValue_ID, conn);
    ...
    /** Load Constructor */
    public X_M_AttributeValue (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
