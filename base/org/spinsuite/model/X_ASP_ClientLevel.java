...
public class X_ASP_ClientLevel extends PO implements I_ASP_ClientLevel
{
    ...
    public X_ASP_ClientLevel (Context ctx, int ASP_ClientLevel_ID, DB conn)
    {
      super (ctx, ASP_ClientLevel_ID, conn);
    ...
    /** Load Constructor */
    public X_ASP_ClientLevel (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setASP_ClientLevel_ID (int ASP_ClientLevel_ID)
	{
		if (ASP_ClientLevel_ID < 1) 
			set_Value (COLUMNNAME_ASP_ClientLevel_ID, null);
		else 
			set_Value (COLUMNNAME_ASP_ClientLevel_ID, Integer.valueOf(ASP_ClientLevel_ID));
	}
