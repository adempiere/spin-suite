...
public class X_PA_ReportCube extends PO implements I_PA_ReportCube
{
    ...
    public X_PA_ReportCube (Context ctx, int PA_ReportCube_ID, DB conn)
    {
      super (ctx, PA_ReportCube_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_PA_ReportCube (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Last Recalculated.
	  ...
	  */
	public void setLastRecalculated (Date LastRecalculated)
	{
	...
	{
		return (Date)get_Value(COLUMNNAME_LastRecalculated);
	}
