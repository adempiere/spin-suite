...
public class X_I_InOutLineConfirm extends PO implements I_I_InOutLineConfirm
{
    ...
    public X_I_InOutLineConfirm (Context ctx, int I_InOutLineConfirm_ID, DB conn)
    {
      super (ctx, I_InOutLineConfirm_ID, conn);
    ...
    /** Load Constructor */
    public X_I_InOutLineConfirm (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setI_InOutLineConfirm_ID (int I_InOutLineConfirm_ID)
	{
		if (I_InOutLineConfirm_ID < 1) 
			set_Value (COLUMNNAME_I_InOutLineConfirm_ID, null);
		else 
			set_Value (COLUMNNAME_I_InOutLineConfirm_ID, Integer.valueOf(I_InOutLineConfirm_ID));
	}
