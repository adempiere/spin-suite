...
public class X_C_OrderSource extends PO implements I_C_OrderSource
{
    ...
    public X_C_OrderSource (Context ctx, int C_OrderSource_ID, DB conn)
    {
      super (ctx, C_OrderSource_ID, conn);
    ...
    /** Load Constructor */
    public X_C_OrderSource (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
