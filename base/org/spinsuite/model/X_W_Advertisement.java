...
public class X_W_Advertisement extends PO implements I_W_Advertisement
{
    ...
    public X_W_Advertisement (Context ctx, int W_Advertisement_ID, DB conn)
    {
      super (ctx, W_Advertisement_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_W_Advertisement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setW_Advertisement_ID (int W_Advertisement_ID)
	{
		if (W_Advertisement_ID < 1) 
			set_Value (COLUMNNAME_W_Advertisement_ID, null);
		else 
			set_Value (COLUMNNAME_W_Advertisement_ID, Integer.valueOf(W_Advertisement_ID));
	}
