...
public class X_AD_AlertProcessorLog extends PO implements I_AD_AlertProcessorLog
{
    ...
    public X_AD_AlertProcessorLog (Context ctx, int AD_AlertProcessorLog_ID, DB conn)
    {
      super (ctx, AD_AlertProcessorLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_AlertProcessorLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_AlertProcessorLog_ID (int AD_AlertProcessorLog_ID)
	{
		if (AD_AlertProcessorLog_ID < 1) 
			set_Value (COLUMNNAME_AD_AlertProcessorLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_AlertProcessorLog_ID, Integer.valueOf(AD_AlertProcessorLog_ID));
	}
