...
public class X_ASP_Workflow extends PO implements I_ASP_Workflow
{
    ...
    public X_ASP_Workflow (Context ctx, int ASP_Workflow_ID, DB conn)
    {
      super (ctx, ASP_Workflow_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_ASP_Workflow (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setASP_Workflow_ID (int ASP_Workflow_ID)
	{
		if (ASP_Workflow_ID < 1) 
			set_Value (COLUMNNAME_ASP_Workflow_ID, null);
		else 
			set_Value (COLUMNNAME_ASP_Workflow_ID, Integer.valueOf(ASP_Workflow_ID));
	}
