...
public class X_AD_Scheduler_Para extends PO implements I_AD_Scheduler_Para
{
    ...
    public X_AD_Scheduler_Para (Context ctx, int AD_Scheduler_Para_ID, DB conn)
    {
      super (ctx, AD_Scheduler_Para_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Scheduler_Para (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
