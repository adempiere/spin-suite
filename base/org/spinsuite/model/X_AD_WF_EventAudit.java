...
public class X_AD_WF_EventAudit extends PO implements I_AD_WF_EventAudit
{
    ...
    public X_AD_WF_EventAudit (Context ctx, int AD_WF_EventAudit_ID, DB conn)
    {
      super (ctx, AD_WF_EventAudit_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_WF_EventAudit (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_WF_EventAudit_ID (int AD_WF_EventAudit_ID)
	{
		if (AD_WF_EventAudit_ID < 1) 
			set_Value (COLUMNNAME_AD_WF_EventAudit_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WF_EventAudit_ID, Integer.valueOf(AD_WF_EventAudit_ID));
	}
