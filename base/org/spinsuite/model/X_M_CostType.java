...
public class X_M_CostType extends PO implements I_M_CostType
{
    ...
    public X_M_CostType (Context ctx, int M_CostType_ID, DB conn)
    {
      super (ctx, M_CostType_ID, conn);
      /** if (M_CostType_ID == 0)
        {
			setM_CostType_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_M_CostType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
