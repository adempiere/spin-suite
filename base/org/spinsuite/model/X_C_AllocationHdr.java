...
public class X_C_AllocationHdr extends PO implements I_C_AllocationHdr
{
    ...
    public X_C_AllocationHdr (Context ctx, int C_AllocationHdr_ID, DB conn)
    {
      super (ctx, C_AllocationHdr_ID, conn);
...
// DR
    ...
    /** Load Constructor */
    public X_C_AllocationHdr (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
