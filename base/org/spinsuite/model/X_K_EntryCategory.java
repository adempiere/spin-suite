...
public class X_K_EntryCategory extends PO implements I_K_EntryCategory
{
    ...
    public X_K_EntryCategory (Context ctx, int K_EntryCategory_ID, DB conn)
    {
      super (ctx, K_EntryCategory_ID, conn);
    ...
    /** Load Constructor */
    public X_K_EntryCategory (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
