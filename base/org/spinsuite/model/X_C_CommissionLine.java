...
public class X_C_CommissionLine extends PO implements I_C_CommissionLine
{
    ...
    public X_C_CommissionLine (Context ctx, int C_CommissionLine_ID, DB conn)
    {
      super (ctx, C_CommissionLine_ID, conn);
...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM C_CommissionLine WHERE C_Commission_ID=@C_Commission_ID@
    ...
    /** Load Constructor */
    public X_C_CommissionLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
