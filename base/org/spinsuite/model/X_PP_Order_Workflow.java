...
public class X_PP_Order_Workflow extends PO implements I_PP_Order_Workflow
{
    ...
    public X_PP_Order_Workflow (Context ctx, int PP_Order_Workflow_ID, DB conn)
    {
      super (ctx, PP_Order_Workflow_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_PP_Order_Workflow (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
