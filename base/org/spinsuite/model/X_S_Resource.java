...
public class X_S_Resource extends PO implements I_S_Resource
{
    ...
    public X_S_Resource (Context ctx, int S_Resource_ID, DB conn)
    {
      super (ctx, S_Resource_ID, conn);
      /** if (S_Resource_ID == 0)
        {
			setIsAvailable (true);
// Y
...
// 100
    ...
    /** Load Constructor */
    public X_S_Resource (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
