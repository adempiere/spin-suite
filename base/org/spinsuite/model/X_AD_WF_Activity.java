...
public class X_AD_WF_Activity extends PO implements I_AD_WF_Activity
{
    ...
    public X_AD_WF_Activity (Context ctx, int AD_WF_Activity_ID, DB conn)
    {
      super (ctx, AD_WF_Activity_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_WF_Activity (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set End Wait.
		...
		End of sleep time
	  */
	public void setEndWaitTime (Date EndWaitTime)
	{
	...
	{
		return (Date)get_Value(COLUMNNAME_EndWaitTime);
	}
