...
public class X_AD_Sequence extends PO implements I_AD_Sequence {
    /** Standard Constructor */
    public X_AD_Sequence (Context ctx, int AD_Sequence_ID, DB conn)
    {
...
// 1000000
    ...
    /** Load Constructor */
    public X_AD_Sequence (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
