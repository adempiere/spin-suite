...
public class X_GL_JournalBatch extends PO implements I_GL_JournalBatch
{
    ...
    public X_GL_JournalBatch (Context ctx, int GL_JournalBatch_ID, DB conn)
    {
      super (ctx, GL_JournalBatch_ID, conn);
...
// A
    ...
    /** Load Constructor */
    public X_GL_JournalBatch (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
