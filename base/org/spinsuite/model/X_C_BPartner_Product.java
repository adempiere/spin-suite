...
public class X_C_BPartner_Product extends PO implements I_C_BPartner_Product
{
    ...
    public X_C_BPartner_Product (Context ctx, int C_BPartner_Product_ID, DB conn)
    {
      super (ctx, C_BPartner_Product_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_BPartner_Product (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
