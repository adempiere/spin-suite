...
public class X_PP_Product_BOM extends PO implements I_PP_Product_BOM
{
    ...
    public X_PP_Product_BOM (Context ctx, int PP_Product_BOM_ID, DB conn)
    {
      super (ctx, PP_Product_BOM_ID, conn);
...
// @#Date@
    ...
    /** Load Constructor */
    public X_PP_Product_BOM (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
