...
public class X_AD_Field extends PO implements I_AD_Field
{
    ...
    public X_AD_Field (Context ctx, int AD_Field_ID, DB conn)
    {
      super (ctx, AD_Field_ID, conn);
      /** if (AD_Field_ID == 0)
        {
			setAD_Column_ID (0);
			setAD_Field_ID (0);
...
// Y
    ...
    /** Load Constructor */
    public X_AD_Field (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
