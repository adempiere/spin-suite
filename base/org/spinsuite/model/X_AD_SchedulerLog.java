...
public class X_AD_SchedulerLog extends PO implements I_AD_SchedulerLog
{
    ...
    public X_AD_SchedulerLog (Context ctx, int AD_SchedulerLog_ID, DB conn)
    {
      super (ctx, AD_SchedulerLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_SchedulerLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_SchedulerLog_ID (int AD_SchedulerLog_ID)
	{
		if (AD_SchedulerLog_ID < 1) 
			set_Value (COLUMNNAME_AD_SchedulerLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_SchedulerLog_ID, Integer.valueOf(AD_SchedulerLog_ID));
	}
