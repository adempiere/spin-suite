...
public class X_CM_CStage extends PO implements I_CM_CStage
{
    ...
    public X_CM_CStage (Context ctx, int CM_CStage_ID, DB conn)
    {
      super (ctx, CM_CStage_ID, conn);
      /** if (CM_CStage_ID == 0)
        {
			setCM_CStage_ID (0);
...
// Y
    ...
    /** Load Constructor */
    public X_CM_CStage (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Get Web Container Stage.
		@return Container Stage contains the staging content like images, text etc.
	  */
	...
	{
		set_Value (COLUMNNAME_ContainerXML, ContainerXML);
	}
