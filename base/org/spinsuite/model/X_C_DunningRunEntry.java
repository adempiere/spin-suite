...
public class X_C_DunningRunEntry extends PO implements I_C_DunningRunEntry
{
    ...
    public X_C_DunningRunEntry (Context ctx, int C_DunningRunEntry_ID, DB conn)
    {
      super (ctx, C_DunningRunEntry_ID, conn);
...
// @C_DunningLevel_ID@
    ...
    /** Load Constructor */
    public X_C_DunningRunEntry (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
