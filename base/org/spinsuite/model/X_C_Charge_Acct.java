...
public class X_C_Charge_Acct extends PO implements I_C_Charge_Acct
{
    ...
    public X_C_Charge_Acct (Context ctx, int C_Charge_Acct_ID, DB conn)
    {
      super (ctx, C_Charge_Acct_ID, conn);
    ...
    /** Load Constructor */
    public X_C_Charge_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
