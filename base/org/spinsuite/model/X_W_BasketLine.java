...
public class X_W_BasketLine extends PO implements I_W_BasketLine
{
    ...
    public X_W_BasketLine (Context ctx, int W_BasketLine_ID, DB conn)
    {
      super (ctx, W_BasketLine_ID, conn);
    ...
    /** Load Constructor */
    public X_W_BasketLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
