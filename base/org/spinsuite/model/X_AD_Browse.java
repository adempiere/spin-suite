...
public class X_AD_Browse extends PO implements I_AD_Browse
{
    ...
    public X_AD_Browse (Context ctx, int AD_Browse_ID, DB conn)
    {
      super (ctx, AD_Browse_ID, conn);
      /** if (AD_Browse_ID == 0)
        {
			setAccessLevel (null);
// 4
    ...
    /** Load Constructor */
    public X_AD_Browse (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
