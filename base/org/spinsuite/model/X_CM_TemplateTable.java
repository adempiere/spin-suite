...
public class X_CM_TemplateTable extends PO implements I_CM_TemplateTable
{
    ...
    public X_CM_TemplateTable (Context ctx, int CM_TemplateTable_ID, DB conn)
    {
      super (ctx, CM_TemplateTable_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_TemplateTable (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
