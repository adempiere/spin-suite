...
public class X_M_ForecastLine extends PO implements I_M_ForecastLine
{
    ...
    public X_M_ForecastLine (Context ctx, int M_ForecastLine_ID, DB conn)
    {
      super (ctx, M_ForecastLine_ID, conn);
...
// @M_Warehouse_ID@
    ...
    /** Load Constructor */
    public X_M_ForecastLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
