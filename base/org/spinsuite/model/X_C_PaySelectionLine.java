...
public class X_C_PaySelectionLine extends PO implements I_C_PaySelectionLine
{
    ...
    public X_C_PaySelectionLine (Context ctx, int C_PaySelectionLine_ID, DB conn)
    {
      super (ctx, C_PaySelectionLine_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_PaySelectionLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
