...
public class X_AD_RelationType extends PO implements I_AD_RelationType
{
    ...
    public X_AD_RelationType (Context ctx, int AD_RelationType_ID, DB conn)
    {
      super (ctx, AD_RelationType_ID, conn);
...
// I
    ...
    /** Load Constructor */
    public X_AD_RelationType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Relation Type.
		...
		Defines the sets of record pairs (and the conditions a given pair must fulfill to be part of one)
	  */
	public void setAD_RelationType_ID (int AD_RelationType_ID)
	{
		if (AD_RelationType_ID < 1) 
			...
			set_Value (COLUMNNAME_AD_RelationType_ID, Integer.valueOf(AD_RelationType_ID));
	}

	/** Get Relation Type.
		@return Defines the sets of record pairs (and the conditions a given pair must fulfill to be part of one)
	  */
