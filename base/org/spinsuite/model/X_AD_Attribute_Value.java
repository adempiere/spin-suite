...
public class X_AD_Attribute_Value extends PO implements I_AD_Attribute_Value
{
    ...
    public X_AD_Attribute_Value (Context ctx, int AD_Attribute_Value_ID, DB conn)
    {
      super (ctx, AD_Attribute_Value_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Attribute_Value (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Attribute_ID (int AD_Attribute_ID)
	{
		if (AD_Attribute_ID < 1) 
			...
			set_Value (COLUMNNAME_AD_Attribute_ID, Integer.valueOf(AD_Attribute_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_V_Date);
	}
