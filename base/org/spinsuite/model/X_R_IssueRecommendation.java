...
public class X_R_IssueRecommendation extends PO implements I_R_IssueRecommendation
{
    ...
    public X_R_IssueRecommendation (Context ctx, int R_IssueRecommendation_ID, DB conn)
    {
      super (ctx, R_IssueRecommendation_ID, conn);
    ...
    /** Load Constructor */
    public X_R_IssueRecommendation (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Issue Recommendation.
		@param R_IssueRecommendation_ID Issue Recommendation	  */
