...
public class X_W_MailMsg extends PO implements I_W_MailMsg
{
    ...
    public X_W_MailMsg (Context ctx, int W_MailMsg_ID, DB conn)
    {
      super (ctx, W_MailMsg_ID, conn);
      /** if (W_MailMsg_ID == 0)
        {
			setMailMsgType (null);
			setMessage (null);
    ...
    /** Load Constructor */
    public X_W_MailMsg (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
