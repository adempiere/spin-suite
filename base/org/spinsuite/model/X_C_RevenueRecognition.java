...
public class X_C_RevenueRecognition extends PO implements I_C_RevenueRecognition
{
    ...
    public X_C_RevenueRecognition (Context ctx, int C_RevenueRecognition_ID, DB conn)
    {
      super (ctx, C_RevenueRecognition_ID, conn);
    ...
    /** Load Constructor */
    public X_C_RevenueRecognition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
