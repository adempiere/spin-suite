...
public class X_AD_Package_Exp extends PO implements I_AD_Package_Exp
{
    ...
    public X_AD_Package_Exp (Context ctx, int AD_Package_Exp_ID, DB conn)
    {
      super (ctx, AD_Package_Exp_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Package_Exp (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
