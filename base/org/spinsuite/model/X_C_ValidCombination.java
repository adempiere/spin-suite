...
public class X_C_ValidCombination extends PO implements I_C_ValidCombination
{
    ...
    public X_C_ValidCombination (Context ctx, int C_ValidCombination_ID, DB conn)
    {
      super (ctx, C_ValidCombination_ID, conn);
    ...
    /** Load Constructor */
    public X_C_ValidCombination (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_Combination, Combination);
	}
	...
	{
		set_Value (COLUMNNAME_IsFullyQualified, Boolean.valueOf(IsFullyQualified));
	}
