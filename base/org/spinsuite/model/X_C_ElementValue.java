...
public class X_C_ElementValue extends PO implements I_C_ElementValue
{
    ...
    public X_C_ElementValue (Context ctx, int C_ElementValue_ID, DB conn)
    {
      super (ctx, C_ElementValue_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_C_ElementValue (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
