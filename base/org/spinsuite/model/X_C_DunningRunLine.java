...
public class X_C_DunningRunLine extends PO implements I_C_DunningRunLine
{
    ...
    public X_C_DunningRunLine (Context ctx, int C_DunningRunLine_ID, DB conn)
    {
      super (ctx, C_DunningRunLine_ID, conn);
    ...
    /** Load Constructor */
    public X_C_DunningRunLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_DunningRunEntry_ID (int C_DunningRunEntry_ID)
	{
		if (C_DunningRunEntry_ID < 1) 
			set_Value (COLUMNNAME_C_DunningRunEntry_ID, null);
		else 
			set_Value (COLUMNNAME_C_DunningRunEntry_ID, Integer.valueOf(C_DunningRunEntry_ID));
	}
	...
	public void setC_DunningRunLine_ID (int C_DunningRunLine_ID)
	{
		if (C_DunningRunLine_ID < 1) 
			set_Value (COLUMNNAME_C_DunningRunLine_ID, null);
		else 
			set_Value (COLUMNNAME_C_DunningRunLine_ID, Integer.valueOf(C_DunningRunLine_ID));
	}
