...
public class X_PP_Order_Cost extends PO implements I_PP_Order_Cost
{
    ...
    public X_PP_Order_Cost (Context ctx, int PP_Order_Cost_ID, DB conn)
    {
      super (ctx, PP_Order_Cost_ID, conn);
    ...
    /** Load Constructor */
    public X_PP_Order_Cost (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_CumulatedAmtPost, CumulatedAmtPost);
	}
	...
	{
		set_Value (COLUMNNAME_CumulatedQtyPost, CumulatedQtyPost);
	}
	...
	public void setPP_Order_Cost_ID (int PP_Order_Cost_ID)
	{
		if (PP_Order_Cost_ID < 1) 
			set_Value (COLUMNNAME_PP_Order_Cost_ID, null);
		else 
			set_Value (COLUMNNAME_PP_Order_Cost_ID, Integer.valueOf(PP_Order_Cost_ID));
	}
