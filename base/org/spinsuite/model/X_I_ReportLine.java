...
public class X_I_ReportLine extends PO implements I_I_ReportLine
{
    ...
    public X_I_ReportLine (Context ctx, int I_ReportLine_ID, DB conn)
    {
      super (ctx, I_ReportLine_ID, conn);
    ...
    /** Load Constructor */
    public X_I_ReportLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setI_ReportLine_ID (int I_ReportLine_ID)
	{
		if (I_ReportLine_ID < 1) 
			set_Value (COLUMNNAME_I_ReportLine_ID, null);
		else 
			set_Value (COLUMNNAME_I_ReportLine_ID, Integer.valueOf(I_ReportLine_ID));
	}
