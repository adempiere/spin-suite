...
public class X_M_InventoryLine extends PO implements I_M_InventoryLine
{
    ...
    public X_M_InventoryLine (Context ctx, int M_InventoryLine_ID, DB conn)
    {
      super (ctx, M_InventoryLine_ID, conn);
...
// @M_Locator_ID@
    ...
    /** Load Constructor */
    public X_M_InventoryLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
