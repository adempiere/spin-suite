...
public class X_AD_SysConfig extends PO implements I_AD_SysConfig
{
    ...
    public X_AD_SysConfig (Context ctx, int AD_SysConfig_ID, DB conn)
    {
...
// U
    ...
    /** Load Constructor */
    public X_AD_SysConfig (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_SysConfig_ID (int AD_SysConfig_ID)
	{
		if (AD_SysConfig_ID < 1) 
			set_Value (COLUMNNAME_AD_SysConfig_ID, null);
		else 
			set_Value (COLUMNNAME_AD_SysConfig_ID, Integer.valueOf(AD_SysConfig_ID));
	}
