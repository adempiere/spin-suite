...
public class X_K_IndexStop extends PO implements I_K_IndexStop
{
    ...
    public X_K_IndexStop (Context ctx, int K_IndexStop_ID, DB conn)
    {
      super (ctx, K_IndexStop_ID, conn);
      /** if (K_IndexStop_ID == 0)
        {
			setIsManual (true);
// Y
    ...
    /** Load Constructor */
    public X_K_IndexStop (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Index Stop.
		@param K_IndexStop_ID Index Stop	  */
	public void setK_IndexStop_ID (int K_IndexStop_ID)
	{
		if (K_IndexStop_ID < 1) 
			set_Value (COLUMNNAME_K_IndexStop_ID, null);
		else 
			set_Value (COLUMNNAME_K_IndexStop_ID, Integer.valueOf(K_IndexStop_ID));
	}
