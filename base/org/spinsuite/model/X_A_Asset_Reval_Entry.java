...
public class X_A_Asset_Reval_Entry extends PO implements I_A_Asset_Reval_Entry
{
    ...
    public X_A_Asset_Reval_Entry (Context ctx, int A_Asset_Reval_Entry_ID, DB conn)
    {
      super (ctx, A_Asset_Reval_Entry_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Reval_Entry (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Reval_Entry_ID (int A_Asset_Reval_Entry_ID)
	{
		if (A_Asset_Reval_Entry_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Reval_Entry_ID, null);
		else 
