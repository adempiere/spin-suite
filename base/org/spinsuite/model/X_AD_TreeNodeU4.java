...
public class X_AD_TreeNodeU4 extends PO implements I_AD_TreeNodeU4
{
    ...
    public X_AD_TreeNodeU4 (Context ctx, int AD_TreeNodeU4_ID, DB conn)
    {
      super (ctx, AD_TreeNodeU4_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeU4 (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
