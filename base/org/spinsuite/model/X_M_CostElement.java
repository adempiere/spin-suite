...
public class X_M_CostElement extends PO implements I_M_CostElement
{
    ...
    public X_M_CostElement (Context ctx, int M_CostElement_ID, DB conn)
    {
      super (ctx, M_CostElement_ID, conn);
    ...
    /** Load Constructor */
    public X_M_CostElement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
