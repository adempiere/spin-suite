...
public class X_M_ChangeNotice extends PO implements I_M_ChangeNotice
{
    ...
    public X_M_ChangeNotice (Context ctx, int M_ChangeNotice_ID, DB conn)
    {
      super (ctx, M_ChangeNotice_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_M_ChangeNotice (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Change Notice.
		@param M_ChangeNotice_ID Change Notice	  */
