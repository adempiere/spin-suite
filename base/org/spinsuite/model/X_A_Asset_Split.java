...
public class X_A_Asset_Split extends PO implements I_A_Asset_Split
{
    ...
    public X_A_Asset_Split (Context ctx, int A_Asset_Split_ID, DB conn)
    {
      super (ctx, A_Asset_Split_ID, conn);
...
// @SQL=SELECT PostingType FROM A_Depreciation_Workfile WHERE A_Depreciation_Workfile.A_Depreciation_Workfile_ID=@A_Depreciation_Workfile_ID@
    ...
    /** Load Constructor */
    public X_A_Asset_Split (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
