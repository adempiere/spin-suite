...
public class X_T_Aging extends PO implements I_T_Aging
{
    ...
    public X_T_Aging (Context ctx, int T_Aging_ID, DB conn)
    {
      super (ctx, T_Aging_ID, conn);
      /** if (T_Aging_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_T_Aging (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
