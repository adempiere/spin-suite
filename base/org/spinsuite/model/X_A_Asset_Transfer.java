...
public class X_A_Asset_Transfer extends PO implements I_A_Asset_Transfer
{
    ...
    public X_A_Asset_Transfer (Context ctx, int A_Asset_Transfer_ID, DB conn)
    {
      super (ctx, A_Asset_Transfer_ID, conn);
...
// @Date@
    ...
    /** Load Constructor */
    public X_A_Asset_Transfer (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Asset_Transfer_ID (int A_Asset_Transfer_ID)
	{
		if (A_Asset_Transfer_ID < 1) 
			set_Value (COLUMNNAME_A_Asset_Transfer_ID, null);
		else 
	...
	{
		set_Value (COLUMNNAME_A_Depreciation_Acct_Str, A_Depreciation_Acct_Str);
	}
	...
	{
		set_Value (COLUMNNAME_A_Disposal_Loss_Str, A_Disposal_Loss_Str);
	}
	...
	{
		set_Value (COLUMNNAME_A_Disposal_Revenue_Str, A_Disposal_Revenue_Str);
	}
