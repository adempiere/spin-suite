...
public class X_PA_ReportLine extends PO implements I_PA_ReportLine
{
    ...
    public X_PA_ReportLine (Context ctx, int PA_ReportLine_ID, DB conn)
    {
      super (ctx, PA_ReportLine_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM PA_ReportLine WHERE PA_ReportLineSet_ID=@PA_ReportLineSet_ID@
    ...
    /** Load Constructor */
    public X_PA_ReportLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
