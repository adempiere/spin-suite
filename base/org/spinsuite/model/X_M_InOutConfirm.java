...
public class X_M_InOutConfirm extends PO implements I_M_InOutConfirm
{
    ...
    public X_M_InOutConfirm (Context ctx, int M_InOutConfirm_ID, DB conn)
    {
      super (ctx, M_InOutConfirm_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_M_InOutConfirm (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
