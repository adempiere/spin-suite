...
public class X_S_Training extends PO implements I_S_Training
{
    ...
    public X_S_Training (Context ctx, int S_Training_ID, DB conn)
    {
      super (ctx, S_Training_ID, conn);
      /** if (S_Training_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_S_Training (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
