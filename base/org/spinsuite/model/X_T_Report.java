...
public class X_T_Report extends PO implements I_T_Report
{
    ...
    public X_T_Report (Context ctx, int T_Report_ID, DB conn)
    {
      super (ctx, T_Report_ID, conn);
      /** if (T_Report_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_T_Report (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_Col_10, Col_10);
	}
	...
	{
		set_Value (COLUMNNAME_Col_11, Col_11);
	}
	...
	{
		set_Value (COLUMNNAME_Col_12, Col_12);
	}
	...
	{
		set_Value (COLUMNNAME_Col_13, Col_13);
	}
	...
	{
		set_Value (COLUMNNAME_Col_14, Col_14);
	}
	...
	{
		set_Value (COLUMNNAME_Col_15, Col_15);
	}
	...
	{
		set_Value (COLUMNNAME_Col_16, Col_16);
	}
	...
	{
		set_Value (COLUMNNAME_Col_17, Col_17);
	}
	...
	{
		set_Value (COLUMNNAME_Col_18, Col_18);
	}
	...
	{
		set_Value (COLUMNNAME_Col_19, Col_19);
	}
	...
	{
		set_Value (COLUMNNAME_Col_20, Col_20);
	}
