...
public class X_GL_Distribution extends PO implements I_GL_Distribution
{
    ...
    public X_GL_Distribution (Context ctx, int GL_Distribution_ID, DB conn)
    {
      super (ctx, GL_Distribution_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_GL_Distribution (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
