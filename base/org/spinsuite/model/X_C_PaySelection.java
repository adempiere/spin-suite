...
public class X_C_PaySelection extends PO implements I_C_PaySelection
{
    ...
    public X_C_PaySelection (Context ctx, int C_PaySelection_ID, DB conn)
    {
      super (ctx, C_PaySelection_ID, conn);
      /** if (C_PaySelection_ID == 0)
        {
			...
			setName (null);
// @#Date@
			setPayDate (new Date( System.currentTimeMillis() ));
// @#Date@
			setProcessed (false);
			setProcessing (false);
    ...
    /** Load Constructor */
    public X_C_PaySelection (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_PayDate);
	}
