...
public class X_GL_DistributionLine extends PO implements I_GL_DistributionLine
{
    ...
    public X_GL_DistributionLine (Context ctx, int GL_DistributionLine_ID, DB conn)
    {
      super (ctx, GL_DistributionLine_ID, conn);
...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM GL_DistributionLine WHERE GL_Distribution_ID=@GL_Distribution_ID@
    ...
    /** Load Constructor */
    public X_GL_DistributionLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setGL_Distribution_ID (int GL_Distribution_ID)
	{
		if (GL_Distribution_ID < 1) 
			set_Value (COLUMNNAME_GL_Distribution_ID, null);
		else 
			set_Value (COLUMNNAME_GL_Distribution_ID, Integer.valueOf(GL_Distribution_ID));
	}
	...
	public void setGL_DistributionLine_ID (int GL_DistributionLine_ID)
	{
		if (GL_DistributionLine_ID < 1) 
			set_Value (COLUMNNAME_GL_DistributionLine_ID, null);
		else 
			set_Value (COLUMNNAME_GL_DistributionLine_ID, Integer.valueOf(GL_DistributionLine_ID));
	}
