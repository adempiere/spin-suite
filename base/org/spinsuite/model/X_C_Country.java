...
public class X_C_Country extends PO implements I_C_Country
{
    ...
    public X_C_Country (Context ctx, int C_Country_ID, DB conn)
    {
...
// @C@, @R@ @P@
    ...
    /** Load Constructor */
    public X_C_Country (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
