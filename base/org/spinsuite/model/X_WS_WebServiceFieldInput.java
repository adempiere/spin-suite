...
public class X_WS_WebServiceFieldInput extends PO implements I_WS_WebServiceFieldInput {
    /** Standard Constructor */
    public X_WS_WebServiceFieldInput (Context ctx, int WS_WebServiceFieldInput_ID, DB conn)
    {
    ...
    /** Load Constructor */
    public X_WS_WebServiceFieldInput (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setWS_WebServiceFieldInput_ID (int WS_WebServiceFieldInput_ID)
	{
		if (WS_WebServiceFieldInput_ID < 1) 
			set_Value (COLUMNNAME_WS_WebServiceFieldInput_ID, null);
		else 
			set_Value (COLUMNNAME_WS_WebServiceFieldInput_ID, Integer.valueOf(WS_WebServiceFieldInput_ID));
	}
