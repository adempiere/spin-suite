...
public class X_A_Depreciation_Convention extends PO implements I_A_Depreciation_Convention
{
    ...
    public X_A_Depreciation_Convention (Context ctx, int A_Depreciation_Convention_ID, DB conn)
    {
      super (ctx, A_Depreciation_Convention_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_A_Depreciation_Convention (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Depreciation_Convention_ID (int A_Depreciation_Convention_ID)
	{
		if (A_Depreciation_Convention_ID < 1) 
			set_Value (COLUMNNAME_A_Depreciation_Convention_ID, null);
		else 
