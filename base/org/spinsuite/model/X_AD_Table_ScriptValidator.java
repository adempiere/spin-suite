...
public class X_AD_Table_ScriptValidator extends PO implements I_AD_Table_ScriptValidator
{
    ...
    public X_AD_Table_ScriptValidator (Context ctx, int AD_Table_ScriptValidator_ID, DB conn)
    {
      super (ctx, AD_Table_ScriptValidator_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_AD_Table_ScriptValidator (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Table Script Validator.
		@param AD_Table_ScriptValidator_ID 
		Script model validator for tables
	  */
	public void setAD_Table_ScriptValidator_ID (int AD_Table_ScriptValidator_ID)
	{
		if (AD_Table_ScriptValidator_ID < 1) 
			set_Value (COLUMNNAME_AD_Table_ScriptValidator_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Table_ScriptValidator_ID, Integer.valueOf(AD_Table_ScriptValidator_ID));
	}

	/** Get Table Script Validator.
		@return Script model validator for tables
	  */
