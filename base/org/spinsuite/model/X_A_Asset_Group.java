...
public class X_A_Asset_Group extends PO implements I_A_Asset_Group
{
    ...
    public X_A_Asset_Group (Context ctx, int A_Asset_Group_ID, DB conn)
    {
      super (ctx, A_Asset_Group_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_A_Asset_Group (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
