...
public class X_M_RMAType extends PO implements I_M_RMAType
{
    ...
    public X_M_RMAType (Context ctx, int M_RMAType_ID, DB conn)
    {
      super (ctx, M_RMAType_ID, conn);
      /** if (M_RMAType_ID == 0)
        {
			setM_RMAType_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_M_RMAType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
