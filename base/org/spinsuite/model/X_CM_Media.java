...
public class X_CM_Media extends PO implements I_CM_Media
{
    ...
    public X_CM_Media (Context ctx, int CM_Media_ID, DB conn)
    {
      super (ctx, CM_Media_ID, conn);
      /** if (CM_Media_ID == 0)
        {
			setCM_Media_ID (0);
    ...
    /** Load Constructor */
    public X_CM_Media (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
