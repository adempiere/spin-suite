...
public class X_PP_MRP extends PO implements I_PP_MRP
{
    ...
    public X_PP_MRP (Context ctx, int PP_MRP_ID, DB conn)
    {
      super (ctx, PP_MRP_ID, conn);
      /** if (PP_MRP_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_PP_MRP (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DateConfirm);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateSimulation);
	}
