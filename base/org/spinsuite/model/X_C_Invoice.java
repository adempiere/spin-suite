...
public class X_C_Invoice extends PO implements I_C_Invoice
{
    ...
    public X_C_Invoice (Context ctx, int C_Invoice_ID, DB conn)
    {
      super (ctx, C_Invoice_ID, conn);
      /** if (C_Invoice_ID == 0)
        {
			setC_BPartner_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_C_Invoice (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DatePrinted);
	}
