...
public class X_AD_WF_NodeNext extends PO implements I_AD_WF_NodeNext
{
    ...
    public X_AD_WF_NodeNext (Context ctx, int AD_WF_NodeNext_ID, DB conn)
    {
      super (ctx, AD_WF_NodeNext_ID, conn);
...
// 10
    ...
    /** Load Constructor */
    public X_AD_WF_NodeNext (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
