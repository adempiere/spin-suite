...
public class X_C_Greeting extends PO implements I_C_Greeting
{
    ...
    public X_C_Greeting (Context ctx, int C_Greeting_ID, DB conn)
    {
      super (ctx, C_Greeting_ID, conn);
      /** if (C_Greeting_ID == 0)
        {
			setC_Greeting_ID (0);
			setIsDefault (false);
    ...
    /** Load Constructor */
    public X_C_Greeting (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
