...
public class X_C_Phase extends PO implements I_C_Phase
{
    ...
    public X_C_Phase (Context ctx, int C_Phase_ID, DB conn)
    {
      super (ctx, C_Phase_ID, conn);
      /** if (C_Phase_ID == 0)
        {
			setC_Phase_ID (0);
...
// 1
    ...
    /** Load Constructor */
    public X_C_Phase (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
