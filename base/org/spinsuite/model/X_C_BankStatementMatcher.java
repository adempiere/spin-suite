...
public class X_C_BankStatementMatcher extends PO implements I_C_BankStatementMatcher
{
    ...
    public X_C_BankStatementMatcher (Context ctx, int C_BankStatementMatcher_ID, DB conn)
    {
      super (ctx, C_BankStatementMatcher_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BankStatementMatcher (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_BankStatementMatcher_ID (int C_BankStatementMatcher_ID)
	{
		if (C_BankStatementMatcher_ID < 1) 
			set_Value (COLUMNNAME_C_BankStatementMatcher_ID, null);
		else 
			set_Value (COLUMNNAME_C_BankStatementMatcher_ID, Integer.valueOf(C_BankStatementMatcher_ID));
	}
