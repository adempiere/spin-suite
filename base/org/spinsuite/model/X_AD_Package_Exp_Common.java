...
public class X_AD_Package_Exp_Common extends PO implements I_AD_Package_Exp_Common
{
    ...
    public X_AD_Package_Exp_Common (Context ctx, int AD_Package_Exp_Common_ID, DB conn)
    {
      super (ctx, AD_Package_Exp_Common_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Package_Exp_Common (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Package_Exp_Common_ID (int AD_Package_Exp_Common_ID)
	{
		if (AD_Package_Exp_Common_ID < 1) 
			set_Value (COLUMNNAME_AD_Package_Exp_Common_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Package_Exp_Common_ID, Integer.valueOf(AD_Package_Exp_Common_ID));
	}
