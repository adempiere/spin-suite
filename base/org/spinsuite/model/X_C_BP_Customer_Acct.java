...
public class X_C_BP_Customer_Acct extends PO implements I_C_BP_Customer_Acct
{
    ...
    public X_C_BP_Customer_Acct (Context ctx, int C_BP_Customer_Acct_ID, DB conn)
    {
      super (ctx, C_BP_Customer_Acct_ID, conn);
    ...
    /** Load Constructor */
    public X_C_BP_Customer_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
