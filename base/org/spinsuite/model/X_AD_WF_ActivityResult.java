...
public class X_AD_WF_ActivityResult extends PO implements I_AD_WF_ActivityResult
{
    ...
    public X_AD_WF_ActivityResult (Context ctx, int AD_WF_ActivityResult_ID, DB conn)
    {
      super (ctx, AD_WF_ActivityResult_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_WF_ActivityResult (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_WF_ActivityResult_ID (int AD_WF_ActivityResult_ID)
	{
		if (AD_WF_ActivityResult_ID < 1) 
			set_Value (COLUMNNAME_AD_WF_ActivityResult_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WF_ActivityResult_ID, Integer.valueOf(AD_WF_ActivityResult_ID));
	}
