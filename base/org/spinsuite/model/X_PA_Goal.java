...
public class X_PA_Goal extends PO implements I_PA_Goal
{
    ...
    public X_PA_Goal (Context ctx, int PA_Goal_ID, DB conn)
    {
      super (ctx, PA_Goal_ID, conn);
      /** if (PA_Goal_ID == 0)
        {
			setChartType (null);
// BC
...
// 1
    ...
    /** Load Constructor */
    public X_PA_Goal (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
