...
public class X_C_CommissionRun extends PO implements I_C_CommissionRun
{
    ...
    public X_C_CommissionRun (Context ctx, int C_CommissionRun_ID, DB conn)
    {
      super (ctx, C_CommissionRun_ID, conn);
    ...
    /** Load Constructor */
    public X_C_CommissionRun (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
