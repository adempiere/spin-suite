...
public class X_R_RequestProcessor extends PO implements I_R_RequestProcessor
{
    ...
    public X_R_RequestProcessor (Context ctx, int R_RequestProcessor_ID, DB conn)
    {
      super (ctx, R_RequestProcessor_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_R_RequestProcessor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Request Processor.
		@param R_RequestProcessor_ID Request Processor	  */
