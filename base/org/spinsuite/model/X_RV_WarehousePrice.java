...
public class X_RV_WarehousePrice extends PO implements I_RV_WarehousePrice
{
    ...
    public X_RV_WarehousePrice (Context ctx, int RV_WarehousePrice_ID, DB conn)
    {
      super (ctx, RV_WarehousePrice_ID, conn);
    ...
    /** Load Constructor */
    public X_RV_WarehousePrice (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
