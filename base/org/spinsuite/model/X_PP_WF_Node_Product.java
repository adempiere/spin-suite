...
public class X_PP_WF_Node_Product extends PO implements I_PP_WF_Node_Product
{
    ...
    public X_PP_WF_Node_Product (Context ctx, int PP_WF_Node_Product_ID, DB conn)
    {
      super (ctx, PP_WF_Node_Product_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_PP_WF_Node_Product (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Workflow Node Product.
		@param PP_WF_Node_Product_ID 
		Workflow Node Product
	  */
	public void setPP_WF_Node_Product_ID (int PP_WF_Node_Product_ID)
	{
		if (PP_WF_Node_Product_ID < 1) 
			set_Value (COLUMNNAME_PP_WF_Node_Product_ID, null);
		else 
			set_Value (COLUMNNAME_PP_WF_Node_Product_ID, Integer.valueOf(PP_WF_Node_Product_ID));
	}
