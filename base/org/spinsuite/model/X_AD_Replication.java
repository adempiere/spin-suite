...
public class X_AD_Replication extends PO implements I_AD_Replication
{
    ...
    public X_AD_Replication (Context ctx, int AD_Replication_ID, DB conn)
    {
      super (ctx, AD_Replication_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_AD_Replication (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setRemote_Client_ID (int Remote_Client_ID)
	{
		if (Remote_Client_ID < 1) 
			set_Value (COLUMNNAME_Remote_Client_ID, null);
		else 
			set_Value (COLUMNNAME_Remote_Client_ID, Integer.valueOf(Remote_Client_ID));
	}
