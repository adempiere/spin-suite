...
public class X_R_StatusCategory extends PO implements I_R_StatusCategory
{
    ...
    public X_R_StatusCategory (Context ctx, int R_StatusCategory_ID, DB conn)
    {
      super (ctx, R_StatusCategory_ID, conn);
    ...
    /** Load Constructor */
    public X_R_StatusCategory (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
