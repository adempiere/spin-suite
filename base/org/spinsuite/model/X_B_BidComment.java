...
public class X_B_BidComment extends PO implements I_B_BidComment
{
    ...
    public X_B_BidComment (Context ctx, int B_BidComment_ID, DB conn)
    {
      super (ctx, B_BidComment_ID, conn);
    ...
    /** Load Constructor */
    public X_B_BidComment (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setB_BidComment_ID (int B_BidComment_ID)
	{
		if (B_BidComment_ID < 1) 
			set_Value (COLUMNNAME_B_BidComment_ID, null);
		else 
			set_Value (COLUMNNAME_B_BidComment_ID, Integer.valueOf(B_BidComment_ID));
	}
