...
public class X_M_Shipper extends PO implements I_M_Shipper
{
    ...
    public X_M_Shipper (Context ctx, int M_Shipper_ID, DB conn)
    {
      super (ctx, M_Shipper_ID, conn);
      /** if (M_Shipper_ID == 0)
        {
			setM_Shipper_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_M_Shipper (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
