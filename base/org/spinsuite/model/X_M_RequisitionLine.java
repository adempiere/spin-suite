...
public class X_M_RequisitionLine extends PO implements I_M_RequisitionLine
{
    ...
    public X_M_RequisitionLine (Context ctx, int M_RequisitionLine_ID, DB conn)
    {
      super (ctx, M_RequisitionLine_ID, conn);
...
// 1
    ...
    /** Load Constructor */
    public X_M_RequisitionLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
