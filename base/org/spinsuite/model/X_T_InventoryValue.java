...
public class X_T_InventoryValue extends PO implements I_T_InventoryValue
{
    ...
    public X_T_InventoryValue (Context ctx, int T_InventoryValue_ID, DB conn)
    {
      super (ctx, T_InventoryValue_ID, conn);
    ...
    /** Load Constructor */
    public X_T_InventoryValue (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DateValue);
	}
