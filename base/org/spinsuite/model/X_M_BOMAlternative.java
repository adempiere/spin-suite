...
public class X_M_BOMAlternative extends PO implements I_M_BOMAlternative
{
    ...
    public X_M_BOMAlternative (Context ctx, int M_BOMAlternative_ID, DB conn)
    {
      super (ctx, M_BOMAlternative_ID, conn);
    ...
    /** Load Constructor */
    public X_M_BOMAlternative (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
