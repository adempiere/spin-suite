...
public class X_PP_Product_BOMLine extends PO implements I_PP_Product_BOMLine
{
    ...
    public X_PP_Product_BOMLine (Context ctx, int PP_Product_BOMLine_ID, DB conn)
    {
      super (ctx, PP_Product_BOMLine_ID, conn);
...
// @#Date@
    ...
    /** Load Constructor */
    public X_PP_Product_BOMLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
