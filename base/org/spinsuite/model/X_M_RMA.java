...
public class X_M_RMA extends PO implements I_M_RMA
{
    ...
    public X_M_RMA (Context ctx, int M_RMA_ID, DB conn)
    {
...
// @IsSOTrx@
    ...
    /** Load Constructor */
    public X_M_RMA (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (InOut_ID < 1) 
			set_Value (COLUMNNAME_InOut_ID, null);
		else 
			set_Value (COLUMNNAME_InOut_ID, Integer.valueOf(InOut_ID));
	}
