...
public class X_C_RfQ extends PO implements I_C_RfQ
{
    ...
    public X_C_RfQ (Context ctx, int C_RfQ_ID, DB conn)
    {
      super (ctx, C_RfQ_ID, conn);
      /** if (C_RfQ_ID == 0)
        {
			setC_Currency_ID (0);
// @$C_Currency_ID @
			setC_RfQ_ID (0);
			setC_RfQ_Topic_ID (0);
			setDateResponse (new Date( System.currentTimeMillis() ));
			setDocumentNo (null);
...
// S
    ...
    /** Load Constructor */
    public X_C_RfQ (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
