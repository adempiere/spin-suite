...
public class X_S_ResourceAssignment extends PO implements I_S_ResourceAssignment
{
    ...
    public X_S_ResourceAssignment (Context ctx, int S_ResourceAssignment_ID, DB conn)
    {
      super (ctx, S_ResourceAssignment_ID, conn);
      /** if (S_ResourceAssignment_ID == 0)
        {
			setAssignDateFrom (new Date( System.currentTimeMillis() ));
    ...
    /** Load Constructor */
    public X_S_ResourceAssignment (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_AssignDateFrom);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_AssignDateTo);
	}
