...
public class X_M_Product_Category_Acct extends PO implements I_M_Product_Category_Acct
{
    ...
    public X_M_Product_Category_Acct (Context ctx, int M_Product_Category_Acct_ID, DB conn)
    {
      super (ctx, M_Product_Category_Acct_ID, conn);
    ...
    /** Load Constructor */
    public X_M_Product_Category_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
