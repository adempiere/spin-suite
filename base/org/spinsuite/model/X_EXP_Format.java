...
public class X_EXP_Format extends PO implements I_EXP_Format
{
    ...
    public X_EXP_Format (Context ctx, int EXP_Format_ID, DB conn)
    {
      super (ctx, EXP_Format_ID, conn);
      /** if (EXP_Format_ID == 0)
        {
			setAD_Table_ID (0);
			setEXP_Format_ID (0);
    ...
    /** Load Constructor */
    public X_EXP_Format (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
