...
public class X_I_BankStatement extends PO implements I_I_BankStatement
{
    ...
    public X_I_BankStatement (Context ctx, int I_BankStatement_ID, DB conn)
    {
      super (ctx, I_BankStatement_ID, conn);
    ...
    /** Load Constructor */
    public X_I_BankStatement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_EftStatementDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_EftStatementLineDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_EftValutaDate);
	}
	...
	public void setI_BankStatement_ID (int I_BankStatement_ID)
	{
		if (I_BankStatement_ID < 1) 
			set_Value (COLUMNNAME_I_BankStatement_ID, null);
		else 
			set_Value (COLUMNNAME_I_BankStatement_ID, Integer.valueOf(I_BankStatement_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_StatementDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_StatementLineDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_ValutaDate);
	}
}