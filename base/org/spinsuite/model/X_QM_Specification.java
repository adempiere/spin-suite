...
public class X_QM_Specification extends PO implements I_QM_Specification
{
    ...
    public X_QM_Specification (Context ctx, int QM_Specification_ID, DB conn)
    {
      super (ctx, QM_Specification_ID, conn);
    ...
    /** Load Constructor */
    public X_QM_Specification (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
