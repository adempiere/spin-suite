...
public class X_CM_BroadcastServer extends PO implements I_CM_BroadcastServer
{
    ...
    public X_CM_BroadcastServer (Context ctx, int CM_BroadcastServer_ID, DB conn)
    {
      super (ctx, CM_BroadcastServer_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_BroadcastServer (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
