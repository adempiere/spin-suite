...
public class X_AD_TaskInstance extends PO implements I_AD_TaskInstance
{
    ...
    public X_AD_TaskInstance (Context ctx, int AD_TaskInstance_ID, DB conn)
    {
      super (ctx, AD_TaskInstance_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TaskInstance (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_TaskInstance_ID (int AD_TaskInstance_ID)
	{
		if (AD_TaskInstance_ID < 1) 
			set_Value (COLUMNNAME_AD_TaskInstance_ID, null);
		else 
			set_Value (COLUMNNAME_AD_TaskInstance_ID, Integer.valueOf(AD_TaskInstance_ID));
	}
