...
public class X_PA_Ratio extends PO implements I_PA_Ratio
{
    ...
    public X_PA_Ratio (Context ctx, int PA_Ratio_ID, DB conn)
    {
      super (ctx, PA_Ratio_ID, conn);
      /** if (PA_Ratio_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_PA_Ratio (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
