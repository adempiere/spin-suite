...
public class X_W_Basket extends PO implements I_W_Basket
{
    ...
    public X_W_Basket (Context ctx, int W_Basket_ID, DB conn)
    {
      super (ctx, W_Basket_ID, conn);
      /** if (W_Basket_ID == 0)
        {
			setAD_User_ID (0);
			setSession_ID (0);
    ...
    /** Load Constructor */
    public X_W_Basket (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
