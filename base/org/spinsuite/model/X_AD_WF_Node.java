...
public class X_AD_WF_Node extends PO implements I_AD_WF_Node
{
    ...
    public X_AD_WF_Node (Context ctx, int AD_WF_Node_ID, DB conn)
    {
      super (ctx, AD_WF_Node_ID, conn);
      /** if (AD_WF_Node_ID == 0)
        {
			setAction (null);
// Z
...
// X
    ...
    /** Load Constructor */
    public X_AD_WF_Node (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
