...
public class X_AD_WorkflowProcessorLog extends PO implements I_AD_WorkflowProcessorLog
{
    ...
    public X_AD_WorkflowProcessorLog (Context ctx, int AD_WorkflowProcessorLog_ID, DB conn)
    {
      super (ctx, AD_WorkflowProcessorLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_WorkflowProcessorLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_WorkflowProcessorLog_ID (int AD_WorkflowProcessorLog_ID)
	{
		if (AD_WorkflowProcessorLog_ID < 1) 
			set_Value (COLUMNNAME_AD_WorkflowProcessorLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WorkflowProcessorLog_ID, Integer.valueOf(AD_WorkflowProcessorLog_ID));
	}
