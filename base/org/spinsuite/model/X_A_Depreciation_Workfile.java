...
public class X_A_Depreciation_Workfile extends PO implements I_A_Depreciation_Workfile
{
    ...
    public X_A_Depreciation_Workfile (Context ctx, int A_Depreciation_Workfile_ID, DB conn)
    {
      super (ctx, A_Depreciation_Workfile_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Workfile (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
