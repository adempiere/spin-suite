...
public class X_AD_InfoColumn extends PO implements I_AD_InfoColumn
{
    ...
    public X_AD_InfoColumn (Context ctx, int AD_InfoColumn_ID, DB conn)
    {
      super (ctx, AD_InfoColumn_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_InfoColumn (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Info Column.
		@param AD_InfoColumn_ID Info Column	  */
