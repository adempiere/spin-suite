...
public class X_AD_Workflow extends PO implements I_AD_Workflow
{
    ...
    public X_AD_Workflow (Context ctx, int AD_Workflow_ID, DB conn)
    {
      super (ctx, AD_Workflow_ID, conn);
      /** if (AD_Workflow_ID == 0)
        {
			setAccessLevel (null);
			setAD_Workflow_ID (0);
...
// G
    ...
    /** Load Constructor */
    public X_AD_Workflow (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
