...
public class X_WS_WebServiceType extends PO implements I_WS_WebServiceType
{
    ...
    public X_WS_WebServiceType (Context ctx, int WS_WebServiceType_ID, DB conn)
    {
    ...
    /** Load Constructor */
    public X_WS_WebServiceType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
