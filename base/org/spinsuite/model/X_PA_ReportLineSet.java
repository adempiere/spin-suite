...
public class X_PA_ReportLineSet extends PO implements I_PA_ReportLineSet
{
    ...
    public X_PA_ReportLineSet (Context ctx, int PA_ReportLineSet_ID, DB conn)
    {
      super (ctx, PA_ReportLineSet_ID, conn);
    ...
    /** Load Constructor */
    public X_PA_ReportLineSet (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
