...
public class X_AD_PrintLabel extends PO implements I_AD_PrintLabel
{
    ...
    public X_AD_PrintLabel (Context ctx, int AD_PrintLabel_ID, DB conn)
    {
      super (ctx, AD_PrintLabel_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_PrintLabel (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
