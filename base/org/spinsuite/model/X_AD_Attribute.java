...
public class X_AD_Attribute extends PO implements I_AD_Attribute
{
    ...
    public X_AD_Attribute (Context ctx, int AD_Attribute_ID, DB conn)
    {
      super (ctx, AD_Attribute_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Attribute (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
