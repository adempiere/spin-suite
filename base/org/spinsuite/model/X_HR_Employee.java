...
public class X_HR_Employee extends PO implements I_HR_Employee
{
    ...
    public X_HR_Employee (Context ctx, int HR_Employee_ID, DB conn)
    {
      super (ctx, HR_Employee_ID, conn);
      /** if (HR_Employee_ID == 0)
        {
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Employee (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
