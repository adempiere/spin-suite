...
public class X_B_Topic extends PO implements I_B_Topic
{
    ...
    public X_B_Topic (Context ctx, int B_Topic_ID, DB conn)
    {
      super (ctx, B_Topic_ID, conn);
      /** if (B_Topic_ID == 0)
        {
			setB_TopicCategory_ID (0);
			setB_Topic_ID (0);
			setB_TopicType_ID (0);
			setDecisionDate (new Date( System.currentTimeMillis() ));
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_B_Topic (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setB_TopicCategory_ID (int B_TopicCategory_ID)
	{
		if (B_TopicCategory_ID < 1) 
			set_Value (COLUMNNAME_B_TopicCategory_ID, null);
		else 
			set_Value (COLUMNNAME_B_TopicCategory_ID, Integer.valueOf(B_TopicCategory_ID));
	}
	...
	{
		if (B_TopicType_ID < 1) 
			set_Value (COLUMNNAME_B_TopicType_ID, null);
		else 
			set_Value (COLUMNNAME_B_TopicType_ID, Integer.valueOf(B_TopicType_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DecisionDate);
	}
