...
public class X_AD_WF_NextCondition extends PO implements I_AD_WF_NextCondition
{
    ...
    public X_AD_WF_NextCondition (Context ctx, int AD_WF_NextCondition_ID, DB conn)
    {
      super (ctx, AD_WF_NextCondition_ID, conn);
...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_WF_NextCondition WHERE AD_WF_NodeNext_ID=@AD_WF_NodeNext_ID@
    ...
    /** Load Constructor */
    public X_AD_WF_NextCondition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_WF_NextCondition_ID (int AD_WF_NextCondition_ID)
	{
		if (AD_WF_NextCondition_ID < 1) 
			set_Value (COLUMNNAME_AD_WF_NextCondition_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WF_NextCondition_ID, Integer.valueOf(AD_WF_NextCondition_ID));
	}
	...
	public void setAD_WF_NodeNext_ID (int AD_WF_NodeNext_ID)
	{
		if (AD_WF_NodeNext_ID < 1) 
			set_Value (COLUMNNAME_AD_WF_NodeNext_ID, null);
		else 
			set_Value (COLUMNNAME_AD_WF_NodeNext_ID, Integer.valueOf(AD_WF_NodeNext_ID));
	}
