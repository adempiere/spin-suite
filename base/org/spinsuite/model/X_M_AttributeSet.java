...
public class X_M_AttributeSet extends PO implements I_M_AttributeSet
{
    ...
    public X_M_AttributeSet (Context ctx, int M_AttributeSet_ID, DB conn)
    {
      super (ctx, M_AttributeSet_ID, conn);
    ...
    /** Load Constructor */
    public X_M_AttributeSet (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
