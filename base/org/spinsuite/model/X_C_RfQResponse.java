...
public class X_C_RfQResponse extends PO implements I_C_RfQResponse
{
    ...
    public X_C_RfQResponse (Context ctx, int C_RfQResponse_ID, DB conn)
    {
      super (ctx, C_RfQResponse_ID, conn);
...
// @C_Currency_ID@
    ...
    /** Load Constructor */
    public X_C_RfQResponse (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_RfQResponse_ID (int C_RfQResponse_ID)
	{
		if (C_RfQResponse_ID < 1) 
			set_Value (COLUMNNAME_C_RfQResponse_ID, null);
		else 
			set_Value (COLUMNNAME_C_RfQResponse_ID, Integer.valueOf(C_RfQResponse_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateInvited);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_DateResponse);
	}
