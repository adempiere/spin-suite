...
public class X_M_AttributeSearch extends PO implements I_M_AttributeSearch
{
    ...
    public X_M_AttributeSearch (Context ctx, int M_AttributeSearch_ID, DB conn)
    {
      super (ctx, M_AttributeSearch_ID, conn);
    ...
    /** Load Constructor */
    public X_M_AttributeSearch (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
