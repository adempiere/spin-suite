...
public class X_HR_Period extends PO implements I_HR_Period
{
    ...
    public X_HR_Period (Context ctx, int HR_Period_ID, DB conn)
    {
      super (ctx, HR_Period_ID, conn);
      /** if (HR_Period_ID == 0)
        {
			setC_Period_ID (0);
			setC_Year_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Period (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (HR_Year_ID < 1) 
			set_Value (COLUMNNAME_HR_Year_ID, null);
		else 
