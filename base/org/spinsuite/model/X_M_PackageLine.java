...
public class X_M_PackageLine extends PO implements I_M_PackageLine
{
    ...
    public X_M_PackageLine (Context ctx, int M_PackageLine_ID, DB conn)
    {
      super (ctx, M_PackageLine_ID, conn);
    ...
    /** Load Constructor */
    public X_M_PackageLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setM_PackageLine_ID (int M_PackageLine_ID)
	{
		if (M_PackageLine_ID < 1) 
			set_Value (COLUMNNAME_M_PackageLine_ID, null);
		else 
			set_Value (COLUMNNAME_M_PackageLine_ID, Integer.valueOf(M_PackageLine_ID));
	}
