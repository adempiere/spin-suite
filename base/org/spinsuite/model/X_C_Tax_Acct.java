...
public class X_C_Tax_Acct extends PO implements I_C_Tax_Acct
{
    ...
    public X_C_Tax_Acct (Context ctx, int C_Tax_Acct_ID, DB conn)
    {
      super (ctx, C_Tax_Acct_ID, conn);
      /** if (C_Tax_Acct_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_C_Tax_Acct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
