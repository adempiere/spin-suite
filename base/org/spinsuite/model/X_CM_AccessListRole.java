...
public class X_CM_AccessListRole extends PO implements I_CM_AccessListRole
{
    ...
    public X_CM_AccessListRole (Context ctx, int CM_AccessListRole_ID, DB conn)
    {
      super (ctx, CM_AccessListRole_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_AccessListRole (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
