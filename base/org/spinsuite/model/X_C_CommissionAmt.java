...
public class X_C_CommissionAmt extends PO implements I_C_CommissionAmt
{
    ...
    public X_C_CommissionAmt (Context ctx, int C_CommissionAmt_ID, DB conn)
    {
      super (ctx, C_CommissionAmt_ID, conn);
    ...
    /** Load Constructor */
    public X_C_CommissionAmt (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
