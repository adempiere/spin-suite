...
public class X_R_RequestProcessor_Route extends PO implements I_R_RequestProcessor_Route
{
    ...
    public X_R_RequestProcessor_Route (Context ctx, int R_RequestProcessor_Route_ID, DB conn)
    {
      super (ctx, R_RequestProcessor_Route_ID, conn);
    ...
    /** Load Constructor */
    public X_R_RequestProcessor_Route (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setR_RequestProcessor_Route_ID (int R_RequestProcessor_Route_ID)
	{
		if (R_RequestProcessor_Route_ID < 1) 
			set_Value (COLUMNNAME_R_RequestProcessor_Route_ID, null);
		else 
			set_Value (COLUMNNAME_R_RequestProcessor_Route_ID, Integer.valueOf(R_RequestProcessor_Route_ID));
	}
