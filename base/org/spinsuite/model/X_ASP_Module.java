...
public class X_ASP_Module extends PO implements I_ASP_Module
{
    ...
    public X_ASP_Module (Context ctx, int ASP_Module_ID, DB conn)
    {
      super (ctx, ASP_Module_ID, conn);
      /** if (ASP_Module_ID == 0)
        {
			setASP_Module_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_ASP_Module (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
