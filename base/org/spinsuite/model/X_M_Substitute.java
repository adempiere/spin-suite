...
public class X_M_Substitute extends PO implements I_M_Substitute
{
    ...
    public X_M_Substitute (Context ctx, int M_Substitute_ID, DB conn)
    {
      super (ctx, M_Substitute_ID, conn);
    ...
    /** Load Constructor */
    public X_M_Substitute (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
