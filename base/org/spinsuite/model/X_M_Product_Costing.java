...
public class X_M_Product_Costing extends PO implements I_M_Product_Costing
{
    ...
    public X_M_Product_Costing (Context ctx, int M_Product_Costing_ID, DB conn)
    {
      super (ctx, M_Product_Costing_ID, conn);
    ...
    /** Load Constructor */
    public X_M_Product_Costing (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_CostAverageCumAmt, CostAverageCumAmt);
	}
	...
	{
		set_Value (COLUMNNAME_CostAverageCumQty, CostAverageCumQty);
	}
	...
	{
		set_Value (COLUMNNAME_CostStandardCumAmt, CostStandardCumAmt);
	}
	...
	{
		set_Value (COLUMNNAME_CostStandardCumQty, CostStandardCumQty);
	}
	...
	{
		set_Value (COLUMNNAME_CostStandardPOAmt, CostStandardPOAmt);
	}
	...
	{
		set_Value (COLUMNNAME_CostStandardPOQty, CostStandardPOQty);
	}
