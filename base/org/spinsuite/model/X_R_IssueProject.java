...
public class X_R_IssueProject extends PO implements I_R_IssueProject
{
    ...
    public X_R_IssueProject (Context ctx, int R_IssueProject_ID, DB conn)
    {
      super (ctx, R_IssueProject_ID, conn);
    ...
    /** Load Constructor */
    public X_R_IssueProject (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Issue Project.
		@param R_IssueProject_ID Issue Project	  */
