...
public class X_AD_AlertProcessor extends PO implements I_AD_AlertProcessor
{
    ...
    public X_AD_AlertProcessor (Context ctx, int AD_AlertProcessor_ID, DB conn)
    {
      super (ctx, AD_AlertProcessor_ID, conn);
...
// 7
    ...
    /** Load Constructor */
    public X_AD_AlertProcessor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
