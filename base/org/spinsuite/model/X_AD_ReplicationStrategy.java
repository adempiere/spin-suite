...
public class X_AD_ReplicationStrategy extends PO implements I_AD_ReplicationStrategy
{
    ...
    public X_AD_ReplicationStrategy (Context ctx, int AD_ReplicationStrategy_ID, DB conn)
    {
      super (ctx, AD_ReplicationStrategy_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_ReplicationStrategy (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
