...
public class X_C_JobCategory extends PO implements I_C_JobCategory
{
    ...
    public X_C_JobCategory (Context ctx, int C_JobCategory_ID, DB conn)
    {
      super (ctx, C_JobCategory_ID, conn);
    ...
    /** Load Constructor */
    public X_C_JobCategory (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Position Category.
		@param C_JobCategory_ID Position Category	  */
