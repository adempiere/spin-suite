...
public class X_HR_Year extends PO implements I_HR_Year
{
    ...
    public X_HR_Year (Context ctx, int HR_Year_ID, DB conn)
    {
      super (ctx, HR_Year_ID, conn);
      /** if (HR_Year_ID == 0)
        {
			setC_Year_ID (0);
			setHR_Payroll_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Year (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
