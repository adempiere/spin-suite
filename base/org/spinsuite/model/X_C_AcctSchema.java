...
public class X_C_AcctSchema extends PO implements I_C_AcctSchema
{
    ...
    public X_C_AcctSchema (Context ctx, int C_AcctSchema_ID, DB conn)
    {
      super (ctx, C_AcctSchema_ID, conn);
...
// -
    ...
    /** Load Constructor */
    public X_C_AcctSchema (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
