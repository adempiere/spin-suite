...
public class X_C_PaymentProcessor extends PO implements I_C_PaymentProcessor
{
    ...
    public X_C_PaymentProcessor (Context ctx, int C_PaymentProcessor_ID, DB conn)
    {
      super (ctx, C_PaymentProcessor_ID, conn);
    ...
    /** Load Constructor */
    public X_C_PaymentProcessor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
