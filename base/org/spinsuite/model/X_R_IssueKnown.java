...
public class X_R_IssueKnown extends PO implements I_R_IssueKnown
{
    ...
    public X_R_IssueKnown (Context ctx, int R_IssueKnown_ID, DB conn)
    {
      super (ctx, R_IssueKnown_ID, conn);
    ...
    /** Load Constructor */
    public X_R_IssueKnown (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
