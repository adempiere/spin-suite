...
public class X_B_SellerFunds extends PO implements I_B_SellerFunds
{
    ...
    public X_B_SellerFunds (Context ctx, int B_SellerFunds_ID, DB conn)
    {
      super (ctx, B_SellerFunds_ID, conn);
    ...
    /** Load Constructor */
    public X_B_SellerFunds (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
