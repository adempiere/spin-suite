...
public class X_C_LandedCost extends PO implements I_C_LandedCost
{
    ...
    public X_C_LandedCost (Context ctx, int C_LandedCost_ID, DB conn)
    {
      super (ctx, C_LandedCost_ID, conn);
...
// Q
    ...
    /** Load Constructor */
    public X_C_LandedCost (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Landed Cost.
		@param C_LandedCost_ID Landed Cost	  */
	public void setC_LandedCost_ID (int C_LandedCost_ID)
	{
		if (C_LandedCost_ID < 1) 
			set_Value (COLUMNNAME_C_LandedCost_ID, null);
		else 
			set_Value (COLUMNNAME_C_LandedCost_ID, Integer.valueOf(C_LandedCost_ID));
	}
