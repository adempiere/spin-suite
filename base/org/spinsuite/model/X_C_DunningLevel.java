...
public class X_C_DunningLevel extends PO implements I_C_DunningLevel
{
    ...
    public X_C_DunningLevel (Context ctx, int C_DunningLevel_ID, DB conn)
    {
      super (ctx, C_DunningLevel_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_DunningLevel (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
