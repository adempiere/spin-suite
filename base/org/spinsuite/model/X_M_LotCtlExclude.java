...
public class X_M_LotCtlExclude extends PO implements I_M_LotCtlExclude
{
    ...
    public X_M_LotCtlExclude (Context ctx, int M_LotCtlExclude_ID, DB conn)
    {
      super (ctx, M_LotCtlExclude_ID, conn);
    ...
    /** Load Constructor */
    public X_M_LotCtlExclude (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setM_LotCtlExclude_ID (int M_LotCtlExclude_ID)
	{
		if (M_LotCtlExclude_ID < 1) 
			set_Value (COLUMNNAME_M_LotCtlExclude_ID, null);
		else 
			set_Value (COLUMNNAME_M_LotCtlExclude_ID, Integer.valueOf(M_LotCtlExclude_ID));
	}
