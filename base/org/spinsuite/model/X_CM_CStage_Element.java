...
public class X_CM_CStage_Element extends PO implements I_CM_CStage_Element
{
    ...
    public X_CM_CStage_Element (Context ctx, int CM_CStage_Element_ID, DB conn)
    {
      super (ctx, CM_CStage_Element_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_CStage_Element (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setCM_CStage_Element_ID (int CM_CStage_Element_ID)
	{
		if (CM_CStage_Element_ID < 1) 
			set_Value (COLUMNNAME_CM_CStage_Element_ID, null);
		else 
			set_Value (COLUMNNAME_CM_CStage_Element_ID, Integer.valueOf(CM_CStage_Element_ID));
	}
