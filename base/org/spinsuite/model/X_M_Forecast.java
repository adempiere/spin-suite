...
public class X_M_Forecast extends PO implements I_M_Forecast
{
    ...
    public X_M_Forecast (Context ctx, int M_Forecast_ID, DB conn)
    {
      super (ctx, M_Forecast_ID, conn);
      /** if (M_Forecast_ID == 0)
        {
			setC_Calendar_ID (0);
			setC_Year_ID (0);
    ...
    /** Load Constructor */
    public X_M_Forecast (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
