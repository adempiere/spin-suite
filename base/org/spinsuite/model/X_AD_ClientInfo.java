...
public class X_AD_ClientInfo extends PO implements I_AD_ClientInfo
{
    ...
    public X_AD_ClientInfo (Context ctx, int AD_ClientInfo_ID, DB conn)
    {
      super (ctx, AD_ClientInfo_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_ClientInfo (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_AcctSchema1_ID (int C_AcctSchema1_ID)
	{
		if (C_AcctSchema1_ID < 1) 
			set_Value (COLUMNNAME_C_AcctSchema1_ID, null);
		else 
			set_Value (COLUMNNAME_C_AcctSchema1_ID, Integer.valueOf(C_AcctSchema1_ID));
	}
