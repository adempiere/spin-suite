...
public class X_AD_PrintGraph extends PO implements I_AD_PrintGraph
{
    ...
    public X_AD_PrintGraph (Context ctx, int AD_PrintGraph_ID, DB conn)
    {
      super (ctx, AD_PrintGraph_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_AD_PrintGraph (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
