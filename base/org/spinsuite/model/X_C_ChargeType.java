...
public class X_C_ChargeType extends PO implements I_C_ChargeType
{
    ...
    public X_C_ChargeType (Context ctx, int C_ChargeType_ID, DB conn)
    {
      super (ctx, C_ChargeType_ID, conn);
    ...
    /** Load Constructor */
    public X_C_ChargeType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
