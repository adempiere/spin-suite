...
public class X_AD_Package_Imp_Inst extends PO implements I_AD_Package_Imp_Inst
{
    ...
    public X_AD_Package_Imp_Inst (Context ctx, int AD_Package_Imp_Inst_ID, DB conn)
    {
      super (ctx, AD_Package_Imp_Inst_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Package_Imp_Inst (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Package_Imp_Inst_ID (int AD_Package_Imp_Inst_ID)
	{
		if (AD_Package_Imp_Inst_ID < 1) 
			set_Value (COLUMNNAME_AD_Package_Imp_Inst_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Package_Imp_Inst_ID, Integer.valueOf(AD_Package_Imp_Inst_ID));
	}
