...
public class X_C_UserRemuneration extends PO implements I_C_UserRemuneration
{
    ...
    public X_C_UserRemuneration (Context ctx, int C_UserRemuneration_ID, DB conn)
    {
      super (ctx, C_UserRemuneration_ID, conn);
    ...
    /** Load Constructor */
    public X_C_UserRemuneration (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_UserRemuneration_ID (int C_UserRemuneration_ID)
	{
		if (C_UserRemuneration_ID < 1) 
			set_Value (COLUMNNAME_C_UserRemuneration_ID, null);
		else 
			set_Value (COLUMNNAME_C_UserRemuneration_ID, Integer.valueOf(C_UserRemuneration_ID));
	}
