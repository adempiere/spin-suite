...
public class X_A_Depreciation_Table_Detail extends PO implements I_A_Depreciation_Table_Detail
{
    ...
    public X_A_Depreciation_Table_Detail (Context ctx, int A_Depreciation_Table_Detail_ID, DB conn)
    {
      super (ctx, A_Depreciation_Table_Detail_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Table_Detail (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Depreciation_Table_Detail_ID (int A_Depreciation_Table_Detail_ID)
	{
		if (A_Depreciation_Table_Detail_ID < 1) 
			set_Value (COLUMNNAME_A_Depreciation_Table_Detail_ID, null);
		else 
