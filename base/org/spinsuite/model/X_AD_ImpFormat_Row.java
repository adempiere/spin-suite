...
public class X_AD_ImpFormat_Row extends PO implements I_AD_ImpFormat_Row
{
    ...
    public X_AD_ImpFormat_Row (Context ctx, int AD_ImpFormat_Row_ID, DB conn)
    {
      super (ctx, AD_ImpFormat_Row_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_ImpFormat_Row WHERE AD_ImpFormat_ID=@AD_ImpFormat_ID@
    ...
    /** Load Constructor */
    public X_AD_ImpFormat_Row (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_ImpFormat_Row_ID (int AD_ImpFormat_Row_ID)
	{
		if (AD_ImpFormat_Row_ID < 1) 
			set_Value (COLUMNNAME_AD_ImpFormat_Row_ID, null);
		else 
			set_Value (COLUMNNAME_AD_ImpFormat_Row_ID, Integer.valueOf(AD_ImpFormat_Row_ID));
	}
