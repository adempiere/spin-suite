...
public class X_M_InOutLineConfirm extends PO implements I_M_InOutLineConfirm
{
    ...
    public X_M_InOutLineConfirm (Context ctx, int M_InOutLineConfirm_ID, DB conn)
    {
      super (ctx, M_InOutLineConfirm_ID, conn);
    ...
    /** Load Constructor */
    public X_M_InOutLineConfirm (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
