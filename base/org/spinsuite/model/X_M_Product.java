...
public class X_M_Product extends PO implements I_M_Product
{
    ...
    public X_M_Product (Context ctx, int M_Product_ID, DB conn)
    {
...
// I
    ...
    /** Load Constructor */
    public X_M_Product (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
