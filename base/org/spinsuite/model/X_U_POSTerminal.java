...
public class X_U_POSTerminal extends PO implements I_U_POSTerminal
{
    ...
    public X_U_POSTerminal (Context ctx, int U_POSTerminal_ID, DB conn)
    {
      super (ctx, U_POSTerminal_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_U_POSTerminal (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_LastLockTime);
	}
	...
	/** Set UnlockingTime.
	  ...
	  */
	public void setUnlockingTime (Date UnlockingTime)
	{
	...
	/** Get UnlockingTime.
	  ...
	  */
	public Date getUnlockingTime () 
	{
		return (Date)get_Value(COLUMNNAME_UnlockingTime);
	}
	...
	public void setU_POSTerminal_ID (int U_POSTerminal_ID)
	{
		if (U_POSTerminal_ID < 1) 
			set_Value (COLUMNNAME_U_POSTerminal_ID, null);
		else 
			set_Value (COLUMNNAME_U_POSTerminal_ID, Integer.valueOf(U_POSTerminal_ID));
	}
