...
public class X_EXP_FormatLine extends PO implements I_EXP_FormatLine
{
    ...
    public X_EXP_FormatLine (Context ctx, int EXP_FormatLine_ID, DB conn)
    {
      super (ctx, EXP_FormatLine_ID, conn);
...
// E
    ...
    /** Load Constructor */
    public X_EXP_FormatLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setEXP_FormatLine_ID (int EXP_FormatLine_ID)
	{
		if (EXP_FormatLine_ID < 1) 
			set_Value (COLUMNNAME_EXP_FormatLine_ID, null);
		else 
			set_Value (COLUMNNAME_EXP_FormatLine_ID, Integer.valueOf(EXP_FormatLine_ID));
	}
