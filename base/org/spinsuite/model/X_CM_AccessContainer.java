...
public class X_CM_AccessContainer extends PO implements I_CM_AccessContainer
{
    ...
    public X_CM_AccessContainer (Context ctx, int CM_AccessContainer_ID, DB conn)
    {
      super (ctx, CM_AccessContainer_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_AccessContainer (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
