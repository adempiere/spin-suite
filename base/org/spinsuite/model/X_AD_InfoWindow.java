...
public class X_AD_InfoWindow extends PO implements I_AD_InfoWindow
{
    ...
    public X_AD_InfoWindow (Context ctx, int AD_InfoWindow_ID, DB conn)
    {
      super (ctx, AD_InfoWindow_ID, conn);
...
// U
    ...
    /** Load Constructor */
    public X_AD_InfoWindow (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Info Window.
		@param AD_InfoWindow_ID Info Window	  */
