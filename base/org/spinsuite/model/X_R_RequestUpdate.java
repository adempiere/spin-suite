...
public class X_R_RequestUpdate extends PO implements I_R_RequestUpdate
{
    ...
    public X_R_RequestUpdate (Context ctx, int R_RequestUpdate_ID, DB conn)
    {
      super (ctx, R_RequestUpdate_ID, conn);
    ...
    /** Load Constructor */
    public X_R_RequestUpdate (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Request Update.
		@param R_RequestUpdate_ID Request Update	  */
