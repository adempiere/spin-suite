...
public class X_M_SerNoCtlExclude extends PO implements I_M_SerNoCtlExclude
{
    ...
    public X_M_SerNoCtlExclude (Context ctx, int M_SerNoCtlExclude_ID, DB conn)
    {
      super (ctx, M_SerNoCtlExclude_ID, conn);
    ...
    /** Load Constructor */
    public X_M_SerNoCtlExclude (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setM_SerNoCtlExclude_ID (int M_SerNoCtlExclude_ID)
	{
		if (M_SerNoCtlExclude_ID < 1) 
			set_Value (COLUMNNAME_M_SerNoCtlExclude_ID, null);
		else 
			set_Value (COLUMNNAME_M_SerNoCtlExclude_ID, Integer.valueOf(M_SerNoCtlExclude_ID));
	}
