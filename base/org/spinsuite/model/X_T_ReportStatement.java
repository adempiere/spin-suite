...
public class X_T_ReportStatement extends PO implements I_T_ReportStatement
{
    ...
    public X_T_ReportStatement (Context ctx, int T_ReportStatement_ID, DB conn)
    {
      super (ctx, T_ReportStatement_ID, conn);
    ...
    /** Load Constructor */
    public X_T_ReportStatement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
