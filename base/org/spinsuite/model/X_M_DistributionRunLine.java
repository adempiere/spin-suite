...
public class X_M_DistributionRunLine extends PO implements I_M_DistributionRunLine
{
    ...
    public X_M_DistributionRunLine (Context ctx, int M_DistributionRunLine_ID, DB conn)
    {
      super (ctx, M_DistributionRunLine_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_M_DistributionRunLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
