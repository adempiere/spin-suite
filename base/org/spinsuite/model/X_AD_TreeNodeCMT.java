...
public class X_AD_TreeNodeCMT extends PO implements I_AD_TreeNodeCMT
{
    ...
    public X_AD_TreeNodeCMT (Context ctx, int AD_TreeNodeCMT_ID, DB conn)
    {
      super (ctx, AD_TreeNodeCMT_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeCMT (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
