...
public class X_M_MovementLine extends PO implements I_M_MovementLine
{
    ...
    public X_M_MovementLine (Context ctx, int M_MovementLine_ID, DB conn)
    {
      super (ctx, M_MovementLine_ID, conn);
...
// 0
    ...
    /** Load Constructor */
    public X_M_MovementLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
