...
public class X_AD_Language extends PO implements I_AD_Language
{
    ...
    public X_AD_Language (Context ctx, int AD_Language_ID, DB conn)
    {
      super (ctx, AD_Language_ID, conn);
      /** if (AD_Language_ID == 0)
        {
			setAD_Language (null);
			setAD_Language_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Language (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_IsBaseLanguage, Boolean.valueOf(IsBaseLanguage));
	}
