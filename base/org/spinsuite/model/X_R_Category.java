...
public class X_R_Category extends PO implements I_R_Category
{
    ...
    public X_R_Category (Context ctx, int R_Category_ID, DB conn)
    {
      super (ctx, R_Category_ID, conn);
      /** if (R_Category_ID == 0)
        {
			setName (null);
			setR_Category_ID (0);
    ...
    /** Load Constructor */
    public X_R_Category (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
