...
public class X_AD_Element extends PO implements I_AD_Element
{
    ...
    public X_AD_Element (Context ctx, int AD_Element_ID, DB conn)
    {
      super (ctx, AD_Element_ID, conn);
      /** if (AD_Element_ID == 0)
        {
			setAD_Element_ID (0);
			setColumnName (null);
...
// U
    ...
    /** Load Constructor */
    public X_AD_Element (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
