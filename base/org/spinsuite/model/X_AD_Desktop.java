...
public class X_AD_Desktop extends PO implements I_AD_Desktop
{
    ...
    public X_AD_Desktop (Context ctx, int AD_Desktop_ID, DB conn)
    {
      super (ctx, AD_Desktop_ID, conn);
      /** if (AD_Desktop_ID == 0)
        {
			setAD_Desktop_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_AD_Desktop (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
