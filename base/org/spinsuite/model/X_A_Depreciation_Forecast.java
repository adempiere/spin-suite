...
public class X_A_Depreciation_Forecast extends PO implements I_A_Depreciation_Forecast
{
    ...
    public X_A_Depreciation_Forecast (Context ctx, int A_Depreciation_Forecast_ID, DB conn)
    {
      super (ctx, A_Depreciation_Forecast_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Depreciation_Forecast (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setA_Depreciation_Forecast_ID (int A_Depreciation_Forecast_ID)
	{
		if (A_Depreciation_Forecast_ID < 1) 
			set_Value (COLUMNNAME_A_Depreciation_Forecast_ID, null);
		else 
