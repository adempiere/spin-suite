...
public class X_M_ProductOperation extends PO implements I_M_ProductOperation
{
    ...
    public X_M_ProductOperation (Context ctx, int M_ProductOperation_ID, DB conn)
    {
      super (ctx, M_ProductOperation_ID, conn);
    ...
    /** Load Constructor */
    public X_M_ProductOperation (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Product Operation.
		@param M_ProductOperation_ID Product Operation	  */
