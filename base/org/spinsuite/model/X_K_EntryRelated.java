...
public class X_K_EntryRelated extends PO implements I_K_EntryRelated
{
    ...
    public X_K_EntryRelated (Context ctx, int K_EntryRelated_ID, DB conn)
    {
      super (ctx, K_EntryRelated_ID, conn);
    ...
    /** Load Constructor */
    public X_K_EntryRelated (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setK_EntryRelated_ID (int K_EntryRelated_ID)
	{
		if (K_EntryRelated_ID < 1) 
			set_Value (COLUMNNAME_K_EntryRelated_ID, null);
		else 
			set_Value (COLUMNNAME_K_EntryRelated_ID, Integer.valueOf(K_EntryRelated_ID));
	}
