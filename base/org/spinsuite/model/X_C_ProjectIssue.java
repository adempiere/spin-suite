...
public class X_C_ProjectIssue extends PO implements I_C_ProjectIssue
{
    ...
    public X_C_ProjectIssue (Context ctx, int C_ProjectIssue_ID, DB conn)
    {
      super (ctx, C_ProjectIssue_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_ProjectIssue (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
