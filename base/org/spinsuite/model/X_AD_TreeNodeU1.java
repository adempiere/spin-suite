...
public class X_AD_TreeNodeU1 extends PO implements I_AD_TreeNodeU1
{
    ...
    public X_AD_TreeNodeU1 (Context ctx, int AD_TreeNodeU1_ID, DB conn)
    {
      super (ctx, AD_TreeNodeU1_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeU1 (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
