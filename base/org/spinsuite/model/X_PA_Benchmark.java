...
public class X_PA_Benchmark extends PO implements I_PA_Benchmark
{
    ...
    public X_PA_Benchmark (Context ctx, int PA_Benchmark_ID, DB conn)
    {
      super (ctx, PA_Benchmark_ID, conn);
    ...
    /** Load Constructor */
    public X_PA_Benchmark (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
