...
public class X_CM_MediaDeploy extends PO implements I_CM_MediaDeploy
{
    ...
    public X_CM_MediaDeploy (Context ctx, int CM_MediaDeploy_ID, DB conn)
    {
      super (ctx, CM_MediaDeploy_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_MediaDeploy (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setCM_MediaDeploy_ID (int CM_MediaDeploy_ID)
	{
		if (CM_MediaDeploy_ID < 1) 
			set_Value (COLUMNNAME_CM_MediaDeploy_ID, null);
		else 
			set_Value (COLUMNNAME_CM_MediaDeploy_ID, Integer.valueOf(CM_MediaDeploy_ID));
	}
	...
	public void setCM_Media_Server_ID (int CM_Media_Server_ID)
	{
		if (CM_Media_Server_ID < 1) 
			set_Value (COLUMNNAME_CM_Media_Server_ID, null);
		else 
			set_Value (COLUMNNAME_CM_Media_Server_ID, Integer.valueOf(CM_Media_Server_ID));
	}
