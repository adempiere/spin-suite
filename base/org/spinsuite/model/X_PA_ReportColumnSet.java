...
public class X_PA_ReportColumnSet extends PO implements I_PA_ReportColumnSet
{
    ...
    public X_PA_ReportColumnSet (Context ctx, int PA_ReportColumnSet_ID, DB conn)
    {
      super (ctx, PA_ReportColumnSet_ID, conn);
    ...
    /** Load Constructor */
    public X_PA_ReportColumnSet (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
