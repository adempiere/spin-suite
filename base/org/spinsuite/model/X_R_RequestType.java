...
public class X_R_RequestType extends PO implements I_R_RequestType
{
    ...
    public X_R_RequestType (Context ctx, int R_RequestType_ID, DB conn)
    {
      super (ctx, R_RequestType_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_R_RequestType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
