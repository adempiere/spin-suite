...
public class X_M_LotCtl extends PO implements I_M_LotCtl
{
    ...
    public X_M_LotCtl (Context ctx, int M_LotCtl_ID, DB conn)
    {
      super (ctx, M_LotCtl_ID, conn);
      /** if (M_LotCtl_ID == 0)
        {
			setCurrentNext (0);
// 100
...
// 100
    ...
    /** Load Constructor */
    public X_M_LotCtl (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
