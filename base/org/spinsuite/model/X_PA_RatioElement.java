...
public class X_PA_RatioElement extends PO implements I_PA_RatioElement
{
    ...
    public X_PA_RatioElement (Context ctx, int PA_RatioElement_ID, DB conn)
    {
      super (ctx, PA_RatioElement_ID, conn);
...
// P
    ...
    /** Load Constructor */
    public X_PA_RatioElement (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setPA_RatioElement_ID (int PA_RatioElement_ID)
	{
		if (PA_RatioElement_ID < 1) 
			set_Value (COLUMNNAME_PA_RatioElement_ID, null);
		else 
			set_Value (COLUMNNAME_PA_RatioElement_ID, Integer.valueOf(PA_RatioElement_ID));
	}
