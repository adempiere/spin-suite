...
public class X_CM_Media_Server extends PO implements I_CM_Media_Server
{
    ...
    public X_CM_Media_Server (Context ctx, int CM_Media_Server_ID, DB conn)
    {
      super (ctx, CM_Media_Server_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_Media_Server (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
