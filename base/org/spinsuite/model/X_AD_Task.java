...
public class X_AD_Task extends PO implements I_AD_Task
{
    ...
    public X_AD_Task (Context ctx, int AD_Task_ID, DB conn)
    {
      super (ctx, AD_Task_ID, conn);
      /** if (AD_Task_ID == 0)
        {
			setAccessLevel (null);
			setAD_Task_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Task (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
