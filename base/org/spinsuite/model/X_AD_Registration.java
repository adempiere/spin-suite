...
public class X_AD_Registration extends PO implements I_AD_Registration
{
    ...
    public X_AD_Registration (Context ctx, int AD_Registration_ID, DB conn)
    {
      super (ctx, AD_Registration_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Registration (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Registration_ID (int AD_Registration_ID)
	{
		if (AD_Registration_ID < 1) 
			set_Value (COLUMNNAME_AD_Registration_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Registration_ID, Integer.valueOf(AD_Registration_ID));
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_StartProductionDate);
	}
}