...
public class X_K_Category extends PO implements I_K_Category
{
    ...
    public X_K_Category (Context ctx, int K_Category_ID, DB conn)
    {
      super (ctx, K_Category_ID, conn);
      /** if (K_Category_ID == 0)
        {
			setK_Category_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_K_Category (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
