...
public class X_M_DiscountSchemaLine extends PO implements I_M_DiscountSchemaLine
{
    ...
    public X_M_DiscountSchemaLine (Context ctx, int M_DiscountSchemaLine_ID, DB conn)
    {
      super (ctx, M_DiscountSchemaLine_ID, conn);
      /** if (M_DiscountSchemaLine_ID == 0)
        {
			setC_ConversionType_ID (0);
			setConversionDate (new Date( System.currentTimeMillis() ));
// @#Date@
...
// C
    ...
    /** Load Constructor */
    public X_M_DiscountSchemaLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_ConversionDate);
	}
	...
	public void setM_DiscountSchemaLine_ID (int M_DiscountSchemaLine_ID)
	{
		if (M_DiscountSchemaLine_ID < 1) 
			set_Value (COLUMNNAME_M_DiscountSchemaLine_ID, null);
		else 
			set_Value (COLUMNNAME_M_DiscountSchemaLine_ID, Integer.valueOf(M_DiscountSchemaLine_ID));
	}
