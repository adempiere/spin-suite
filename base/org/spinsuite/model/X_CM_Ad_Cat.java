...
public class X_CM_Ad_Cat extends PO implements I_CM_Ad_Cat
{
    ...
    public X_CM_Ad_Cat (Context ctx, int CM_Ad_Cat_ID, DB conn)
    {
      super (ctx, CM_Ad_Cat_ID, conn);
      /** if (CM_Ad_Cat_ID == 0)
        {
			setCM_Ad_Cat_ID (0);
    ...
    /** Load Constructor */
    public X_CM_Ad_Cat (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Advertisement Category.
		@param CM_Ad_Cat_ID 
		Advertisement Categories define rotations and ad blocks
	  */
	...
	/** Get Advertisement Category.
		@return Advertisement Categories define rotations and ad blocks
	  */
