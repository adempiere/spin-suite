...
public class X_M_Storage extends PO implements I_M_Storage
{
    ...
    public X_M_Storage (Context ctx, int M_Storage_ID, DB conn)
    {
      super (ctx, M_Storage_ID, conn);
      /** if (M_Storage_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_M_Storage (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_DateLastInventory);
	}
