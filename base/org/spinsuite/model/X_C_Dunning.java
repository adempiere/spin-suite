...
public class X_C_Dunning extends PO implements I_C_Dunning
{
    ...
    public X_C_Dunning (Context ctx, int C_Dunning_ID, DB conn)
    {
      super (ctx, C_Dunning_ID, conn);
      /** if (C_Dunning_ID == 0)
        {
			setC_Dunning_ID (0);
    ...
    /** Load Constructor */
    public X_C_Dunning (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
