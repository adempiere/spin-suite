...
public class X_I_PriceList extends PO implements I_I_PriceList
{
    ...
    public X_I_PriceList (Context ctx, int I_PriceList_ID, DB conn)
    {
      super (ctx, I_PriceList_ID, conn);
      /** if (I_PriceList_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_I_PriceList (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Import Price List.
		@param I_PriceList_ID 
		Import Price List and Versions
	  */
	public void setI_PriceList_ID (int I_PriceList_ID)
	{
		if (I_PriceList_ID < 1) 
			set_Value (COLUMNNAME_I_PriceList_ID, null);
		else 
			set_Value (COLUMNNAME_I_PriceList_ID, Integer.valueOf(I_PriceList_ID));
	}

	/** Get Import Price List.
		@return Import Price List and Versions
	  */
