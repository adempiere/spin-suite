...
public class X_HR_Concept extends PO implements I_HR_Concept
{
    ...
    public X_HR_Concept (Context ctx, int HR_Concept_ID, DB conn)
    {
      super (ctx, HR_Concept_ID, conn);
      /** if (HR_Concept_ID == 0)
        {
			setColumnType (null);
			setHR_Concept_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Concept (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
