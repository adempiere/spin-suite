...
public class X_AD_AccessLog extends PO implements I_AD_AccessLog
{
    ...
    public X_AD_AccessLog (Context ctx, int AD_AccessLog_ID, DB conn)
    {
      super (ctx, AD_AccessLog_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_AccessLog (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_AccessLog_ID (int AD_AccessLog_ID)
	{
		if (AD_AccessLog_ID < 1) 
			set_Value (COLUMNNAME_AD_AccessLog_ID, null);
		else 
			set_Value (COLUMNNAME_AD_AccessLog_ID, Integer.valueOf(AD_AccessLog_ID));
	}
