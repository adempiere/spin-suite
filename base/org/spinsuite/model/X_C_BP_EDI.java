...
public class X_C_BP_EDI extends PO implements I_C_BP_EDI
{
    ...
    public X_C_BP_EDI (Context ctx, int C_BP_EDI_ID, DB conn)
    {
      super (ctx, C_BP_EDI_ID, conn);
      /** if (C_BP_EDI_ID == 0)
        {
			setAD_Sequence_ID (0);
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_C_BP_EDI (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
