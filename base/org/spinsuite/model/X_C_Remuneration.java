...
public class X_C_Remuneration extends PO implements I_C_Remuneration
{
    ...
    public X_C_Remuneration (Context ctx, int C_Remuneration_ID, DB conn)
    {
      super (ctx, C_Remuneration_ID, conn);
    ...
    /** Load Constructor */
    public X_C_Remuneration (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Remuneration.
		@param C_Remuneration_ID Remuneration	  */
