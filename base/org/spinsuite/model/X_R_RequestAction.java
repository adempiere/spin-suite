...
public class X_R_RequestAction extends PO implements I_R_RequestAction
{
    ...
    public X_R_RequestAction (Context ctx, int R_RequestAction_ID, DB conn)
    {
      super (ctx, R_RequestAction_ID, conn);
    ...
    /** Load Constructor */
    public X_R_RequestAction (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setIsEscalated (String IsEscalated)
	{
		...
		set_Value (COLUMNNAME_IsEscalated, IsEscalated);
	}
	...
	/** Set Request History.
		@param R_RequestAction_ID Request History	  */
