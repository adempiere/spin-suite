...
public class X_C_SubscriptionType extends PO implements I_C_SubscriptionType
{
    ...
    public X_C_SubscriptionType (Context ctx, int C_SubscriptionType_ID, DB conn)
    {
      super (ctx, C_SubscriptionType_ID, conn);
    ...
    /** Load Constructor */
    public X_C_SubscriptionType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
