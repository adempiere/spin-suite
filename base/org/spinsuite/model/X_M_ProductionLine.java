...
public class X_M_ProductionLine extends PO implements I_M_ProductionLine
{
    ...
    public X_M_ProductionLine (Context ctx, int M_ProductionLine_ID, DB conn)
    {
      super (ctx, M_ProductionLine_ID, conn);
...
// @M_Locator_ID@
    ...
    /** Load Constructor */
    public X_M_ProductionLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setM_ProductionPlan_ID (int M_ProductionPlan_ID)
	{
		if (M_ProductionPlan_ID < 1) 
			set_Value (COLUMNNAME_M_ProductionPlan_ID, null);
		else 
