...
public class X_AD_UserDef_Win extends PO implements I_AD_UserDef_Win
{
    ...
    public X_AD_UserDef_Win (Context ctx, int AD_UserDef_Win_ID, DB conn)
    {
      super (ctx, AD_UserDef_Win_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_UserDef_Win (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
