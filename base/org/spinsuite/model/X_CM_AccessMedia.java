...
public class X_CM_AccessMedia extends PO implements I_CM_AccessMedia
{
    ...
    public X_CM_AccessMedia (Context ctx, int CM_AccessMedia_ID, DB conn)
    {
      super (ctx, CM_AccessMedia_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_AccessMedia (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
