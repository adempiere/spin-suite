...
public class X_AD_TreeNodeCMC extends PO implements I_AD_TreeNodeCMC
{
    ...
    public X_AD_TreeNodeCMC (Context ctx, int AD_TreeNodeCMC_ID, DB conn)
    {
      super (ctx, AD_TreeNodeCMC_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_TreeNodeCMC (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
