...
public class X_PA_ReportColumn extends PO implements I_PA_ReportColumn
{
    ...
    public X_PA_ReportColumn (Context ctx, int PA_ReportColumn_ID, DB conn)
    {
      super (ctx, PA_ReportColumn_ID, conn);
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM PA_ReportColumn WHERE PA_ReportColumnSet_ID=@PA_ReportColumnSet_ID@
    ...
    /** Load Constructor */
    public X_PA_ReportColumn (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
