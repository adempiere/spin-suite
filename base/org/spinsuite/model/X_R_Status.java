...
public class X_R_Status extends PO implements I_R_Status
{
    ...
    public X_R_Status (Context ctx, int R_Status_ID, DB conn)
    {
      super (ctx, R_Status_ID, conn);
      /** if (R_Status_ID == 0)
        {
			setIsClosed (false);
// N
...
// N
    ...
    /** Load Constructor */
    public X_R_Status (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
