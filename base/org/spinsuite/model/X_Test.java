...
public class X_Test extends PO implements I_Test
{
    ...
    public X_Test (Context ctx, int Test_ID, DB conn)
    {
      super (ctx, Test_ID, conn);
      /** if (Test_ID == 0)
        {
			setName (null);
			setTest_ID (0);
    ...
    /** Load Constructor */
    public X_Test (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_T_Date);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_T_DateTime);
	}
