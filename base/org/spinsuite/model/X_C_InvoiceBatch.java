...
public class X_C_InvoiceBatch extends PO implements I_C_InvoiceBatch
{
    ...
    public X_C_InvoiceBatch (Context ctx, int C_InvoiceBatch_ID, DB conn)
    {
      super (ctx, C_InvoiceBatch_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_C_InvoiceBatch (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		set_Value (COLUMNNAME_DocumentAmt, DocumentAmt);
	}
