...
public class X_I_Conversion_Rate extends PO implements I_I_Conversion_Rate
{
    ...
    public X_I_Conversion_Rate (Context ctx, int I_Conversion_Rate_ID, DB conn)
    {
      super (ctx, I_Conversion_Rate_ID, conn);
    ...
    /** Load Constructor */
    public X_I_Conversion_Rate (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setI_Conversion_Rate_ID (int I_Conversion_Rate_ID)
	{
		if (I_Conversion_Rate_ID < 1) 
			set_Value (COLUMNNAME_I_Conversion_Rate_ID, null);
		else 
			set_Value (COLUMNNAME_I_Conversion_Rate_ID, Integer.valueOf(I_Conversion_Rate_ID));
	}
