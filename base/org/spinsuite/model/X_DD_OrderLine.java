...
public class X_DD_OrderLine extends PO implements I_DD_OrderLine
{
    ...
    public X_DD_OrderLine (Context ctx, int DD_OrderLine_ID, DB conn)
    {
      super (ctx, DD_OrderLine_ID, conn);
...
// @M_Locator_ID@
    ...
    /** Load Constructor */
    public X_DD_OrderLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
