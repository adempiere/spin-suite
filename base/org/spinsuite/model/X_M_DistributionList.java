...
public class X_M_DistributionList extends PO implements I_M_DistributionList
{
    ...
    public X_M_DistributionList (Context ctx, int M_DistributionList_ID, DB conn)
    {
      super (ctx, M_DistributionList_ID, conn);
    ...
    /** Load Constructor */
    public X_M_DistributionList (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
