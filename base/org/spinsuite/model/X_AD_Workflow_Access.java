...
public class X_AD_Workflow_Access extends PO implements I_AD_Workflow_Access
{
    ...
    public X_AD_Workflow_Access (Context ctx, int AD_Workflow_Access_ID, DB conn)
    {
      super (ctx, AD_Workflow_Access_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Workflow_Access (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
