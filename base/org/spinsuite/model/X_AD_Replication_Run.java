...
public class X_AD_Replication_Run extends PO implements I_AD_Replication_Run
{
    ...
    public X_AD_Replication_Run (Context ctx, int AD_Replication_Run_ID, DB conn)
    {
      super (ctx, AD_Replication_Run_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Replication_Run (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Replication_ID (int AD_Replication_ID)
	{
		if (AD_Replication_ID < 1) 
			set_Value (COLUMNNAME_AD_Replication_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Replication_ID, Integer.valueOf(AD_Replication_ID));
	}
