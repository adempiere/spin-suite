...
public class X_R_IssueStatus extends PO implements I_R_IssueStatus
{
    ...
    public X_R_IssueStatus (Context ctx, int R_IssueStatus_ID, DB conn)
    {
      super (ctx, R_IssueStatus_ID, conn);
    ...
    /** Load Constructor */
    public X_R_IssueStatus (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set Issue Status.
		@param R_IssueStatus_ID Issue Status	  */
