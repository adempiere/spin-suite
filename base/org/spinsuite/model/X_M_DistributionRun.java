...
public class X_M_DistributionRun extends PO implements I_M_DistributionRun
{
    ...
    public X_M_DistributionRun (Context ctx, int M_DistributionRun_ID, DB conn)
    {
      super (ctx, M_DistributionRun_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_M_DistributionRun (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
