...
public class X_HR_Process extends PO implements I_HR_Process
{
    ...
    public X_HR_Process (Context ctx, int HR_Process_ID, DB conn)
    {
      super (ctx, HR_Process_ID, conn);
      /** if (HR_Process_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_HR_Process (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
