...
public class X_AD_View_Definition extends PO implements I_AD_View_Definition
{
    ...
    public X_AD_View_Definition (Context ctx, int AD_View_Definition_ID, DB conn)
    {
      super (ctx, AD_View_Definition_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_View_Definition (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	/** Set View Definition.
		@param AD_View_Definition_ID View Definition	  */
