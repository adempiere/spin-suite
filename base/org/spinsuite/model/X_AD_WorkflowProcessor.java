...
public class X_AD_WorkflowProcessor extends PO implements I_AD_WorkflowProcessor
{
    ...
    public X_AD_WorkflowProcessor (Context ctx, int AD_WorkflowProcessor_ID, DB conn)
    {
      super (ctx, AD_WorkflowProcessor_ID, conn);
...
// 7
    ...
    /** Load Constructor */
    public X_AD_WorkflowProcessor (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
