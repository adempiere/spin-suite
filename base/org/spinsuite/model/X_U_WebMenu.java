...
public class X_U_WebMenu extends PO implements I_U_WebMenu
{
    ...
    public X_U_WebMenu (Context ctx, int U_WebMenu_ID, DB conn)
    {
      super (ctx, U_WebMenu_ID, conn);
      /** if (U_WebMenu_ID == 0)
        {
			setHasSubMenu (false);
// 'N'
    ...
    /** Load Constructor */
    public X_U_WebMenu (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
