...
public class X_C_Subscription_Delivery extends PO implements I_C_Subscription_Delivery
{
    ...
    public X_C_Subscription_Delivery (Context ctx, int C_Subscription_Delivery_ID, DB conn)
    {
      super (ctx, C_Subscription_Delivery_ID, conn);
    ...
    /** Load Constructor */
    public X_C_Subscription_Delivery (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setC_Subscription_Delivery_ID (int C_Subscription_Delivery_ID)
	{
		if (C_Subscription_Delivery_ID < 1) 
			set_Value (COLUMNNAME_C_Subscription_Delivery_ID, null);
		else 
			set_Value (COLUMNNAME_C_Subscription_Delivery_ID, Integer.valueOf(C_Subscription_Delivery_ID));
	}
