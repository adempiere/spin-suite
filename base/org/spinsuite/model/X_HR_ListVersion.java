...
public class X_HR_ListVersion extends PO implements I_HR_ListVersion
{
    ...
    public X_HR_ListVersion (Context ctx, int HR_ListVersion_ID, DB conn)
    {
      super (ctx, HR_ListVersion_ID, conn);
      /** if (HR_ListVersion_ID == 0)
        {
			...
			setValidTo (new Date( System.currentTimeMillis() ));
        } */
    }

    /** Load Constructor */
    public X_HR_ListVersion (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		if (HR_List_ID < 1) 
			set_Value (COLUMNNAME_HR_List_ID, null);
		else 
			set_Value (COLUMNNAME_HR_List_ID, Integer.valueOf(HR_List_ID));
	}
	...
	public void setHR_ListVersion_ID (int HR_ListVersion_ID)
	{
		if (HR_ListVersion_ID < 1) 
			set_Value (COLUMNNAME_HR_ListVersion_ID, null);
		else 
			set_Value (COLUMNNAME_HR_ListVersion_ID, Integer.valueOf(HR_ListVersion_ID));
	}
