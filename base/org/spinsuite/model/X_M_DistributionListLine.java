...
public class X_M_DistributionListLine extends PO implements I_M_DistributionListLine
{
    ...
    public X_M_DistributionListLine (Context ctx, int M_DistributionListLine_ID, DB conn)
    {
      super (ctx, M_DistributionListLine_ID, conn);
    ...
    /** Load Constructor */
    public X_M_DistributionListLine (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
