...
public class X_AD_Window extends PO implements I_AD_Window
{
    ...
    public X_AD_Window (Context ctx, int AD_Window_ID, DB conn)
    {
      super (ctx, AD_Window_ID, conn);
      /** if (AD_Window_ID == 0)
        {
			setAD_Window_ID (0);
			setEntityType (null);
...
// M
    ...
    /** Load Constructor */
    public X_AD_Window (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
