...
public class X_AD_Replication_Log extends PO implements I_AD_Replication_Log
{
    ...
    public X_AD_Replication_Log (Context ctx, int AD_Replication_Log_ID, DB conn)
    {
      super (ctx, AD_Replication_Log_ID, conn);
...
// N
    ...
    /** Load Constructor */
    public X_AD_Replication_Log (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setAD_Replication_Log_ID (int AD_Replication_Log_ID)
	{
		if (AD_Replication_Log_ID < 1) 
			set_Value (COLUMNNAME_AD_Replication_Log_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Replication_Log_ID, Integer.valueOf(AD_Replication_Log_ID));
	}
	...
	public void setAD_Replication_Run_ID (int AD_Replication_Run_ID)
	{
		if (AD_Replication_Run_ID < 1) 
			set_Value (COLUMNNAME_AD_Replication_Run_ID, null);
		else 
			set_Value (COLUMNNAME_AD_Replication_Run_ID, Integer.valueOf(AD_Replication_Run_ID));
	}
