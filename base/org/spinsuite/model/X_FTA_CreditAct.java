...
public class X_FTA_CreditAct extends PO implements I_FTA_CreditAct
{
    ...
    public X_FTA_CreditAct (Context ctx, int FTA_CreditAct_ID, DB conn)
    {
      super (ctx, FTA_CreditAct_ID, conn);
...
// DR
    ...
    /** Load Constructor */
    public X_FTA_CreditAct (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
