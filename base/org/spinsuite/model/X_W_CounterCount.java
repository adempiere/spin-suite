...
public class X_W_CounterCount extends PO implements I_W_CounterCount
{
    ...
    public X_W_CounterCount (Context ctx, int W_CounterCount_ID, DB conn)
    {
      super (ctx, W_CounterCount_ID, conn);
    ...
    /** Load Constructor */
    public X_W_CounterCount (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
