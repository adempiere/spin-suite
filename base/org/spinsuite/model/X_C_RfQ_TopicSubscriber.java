...
public class X_C_RfQ_TopicSubscriber extends PO implements I_C_RfQ_TopicSubscriber
{
    ...
    public X_C_RfQ_TopicSubscriber (Context ctx, int C_RfQ_TopicSubscriber_ID, DB conn)
    {
      super (ctx, C_RfQ_TopicSubscriber_ID, conn);
    ...
    /** Load Constructor */
    public X_C_RfQ_TopicSubscriber (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_OptOutDate);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_SubscribeDate);
	}
}