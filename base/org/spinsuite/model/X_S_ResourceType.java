...
public class X_S_ResourceType extends PO implements I_S_ResourceType
{
    ...
    public X_S_ResourceType (Context ctx, int S_ResourceType_ID, DB conn)
    {
      super (ctx, S_ResourceType_ID, conn);
...
// Y
    ...
    /** Load Constructor */
    public X_S_ResourceType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	{
		return (Date)get_Value(COLUMNNAME_TimeSlotEnd);
	}
	...
	{
		return (Date)get_Value(COLUMNNAME_TimeSlotStart);
	}
