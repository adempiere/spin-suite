...
public class X_HR_ListType extends PO implements I_HR_ListType
{
    ...
    public X_HR_ListType (Context ctx, int HR_ListType_ID, DB conn)
    {
      super (ctx, HR_ListType_ID, conn);
      /** if (HR_ListType_ID == 0)
        {
			setHR_ListType_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_ListType (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
