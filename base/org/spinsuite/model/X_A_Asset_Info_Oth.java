...
public class X_A_Asset_Info_Oth extends PO implements I_A_Asset_Info_Oth
{
    ...
    public X_A_Asset_Info_Oth (Context ctx, int A_Asset_Info_Oth_ID, DB conn)
    {
      super (ctx, A_Asset_Info_Oth_ID, conn);
    ...
    /** Load Constructor */
    public X_A_Asset_Info_Oth (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
