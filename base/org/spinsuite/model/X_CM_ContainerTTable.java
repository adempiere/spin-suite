...
public class X_CM_ContainerTTable extends PO implements I_CM_ContainerTTable
{
    ...
    public X_CM_ContainerTTable (Context ctx, int CM_ContainerTTable_ID, DB conn)
    {
      super (ctx, CM_ContainerTTable_ID, conn);
    ...
    /** Load Constructor */
    public X_CM_ContainerTTable (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
	...
	public void setCM_ContainerTTable_ID (int CM_ContainerTTable_ID)
	{
		if (CM_ContainerTTable_ID < 1) 
			set_Value (COLUMNNAME_CM_ContainerTTable_ID, null);
		else 
			set_Value (COLUMNNAME_CM_ContainerTTable_ID, Integer.valueOf(CM_ContainerTTable_ID));
	}
