...
public class X_M_FreightCategory extends PO implements I_M_FreightCategory
{
    ...
    public X_M_FreightCategory (Context ctx, int M_FreightCategory_ID, DB conn)
    {
      super (ctx, M_FreightCategory_ID, conn);
    ...
    /** Load Constructor */
    public X_M_FreightCategory (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
