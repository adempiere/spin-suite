...
public class X_PA_Hierarchy extends PO implements I_PA_Hierarchy
{
    ...
    public X_PA_Hierarchy (Context ctx, int PA_Hierarchy_ID, DB conn)
    {
      super (ctx, PA_Hierarchy_ID, conn);
    ...
    /** Load Constructor */
    public X_PA_Hierarchy (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
