...
public class X_AD_Browse_Field extends PO implements I_AD_Browse_Field
{
    ...
    public X_AD_Browse_Field (Context ctx, int AD_Browse_Field_ID, DB conn)
    {
      super (ctx, AD_Browse_Field_ID, conn);
    ...
    /** Load Constructor */
    public X_AD_Browse_Field (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
