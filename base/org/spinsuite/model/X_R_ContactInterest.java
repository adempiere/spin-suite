...
public class X_R_ContactInterest extends PO implements I_R_ContactInterest
{
    ...
    public X_R_ContactInterest (Context ctx, int R_ContactInterest_ID, DB conn)
    {
      super (ctx, R_ContactInterest_ID, conn);
...
// @AD_User_ID@
    ...
    /** Load Constructor */
    public X_R_ContactInterest (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
