...
public class X_M_MovementLineMA extends PO implements I_M_MovementLineMA
{
    ...
    public X_M_MovementLineMA (Context ctx, int M_MovementLineMA_ID, DB conn)
    {
      super (ctx, M_MovementLineMA_ID, conn);
    ...
    /** Load Constructor */
    public X_M_MovementLineMA (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
