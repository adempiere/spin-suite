...
public class X_C_InvoiceSchedule extends PO implements I_C_InvoiceSchedule
{
    ...
    public X_C_InvoiceSchedule (Context ctx, int C_InvoiceSchedule_ID, DB conn)
    {
      super (ctx, C_InvoiceSchedule_ID, conn);
...
// 1
    ...
    /** Load Constructor */
    public X_C_InvoiceSchedule (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
