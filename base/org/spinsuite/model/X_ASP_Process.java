...
public class X_ASP_Process extends PO implements I_ASP_Process
{
    ...
    public X_ASP_Process (Context ctx, int ASP_Process_ID, DB conn)
    {
      super (ctx, ASP_Process_ID, conn);
      /** if (ASP_Process_ID == 0)
        {
			setAD_Process_ID (0);
			setASP_Level_ID (0);
...
// U
    ...
    /** Load Constructor */
    public X_ASP_Process (Context ctx, Cursor rs, DB conn)
    {
      super (ctx, rs, conn);
    }
