...
//			AD_Language_es_MX,  new Locale("es","MX"), true, "dd/MM/yyyy"),
//		new Language ("Espa\u00f1ol (CO)",
//			AD_Language_es_CO,  new Locale("es","ES"), false, "dd/MM/yyyy"),
//		new Language ("Espa\u00f1ol (VE)",
//			AD_Language_es_ES,  new Locale("es","ES"), false, "dd/MM/yyyy"),
//		new Language ("Espa\u00f1ol (EC)",
//			AD_Language_es_ES,  new Locale("es","ES"), false, "dd/MM/yyyy"),
//		new Language ("Espa\u00f1ol (DO)",
//			AD_Language_es_DO,  new Locale("es","DO"), true, "dd/MM/yyyy"),
//		new Language ("\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac (GR)",
//			AD_Language_el_GR,  new Locale("el","GR"),  false, "dd/MM/yyyy"),
//		new Language ("Farsi",
//			AD_Language_fa_IR,  new Locale("fa","IR"),  false, "dd-MM-yyyy"),
//		new Language ("Finnish",
//			AD_Language_fi_FI,  new Locale("fi","FI"),  true, "dd.MM.yyyy"),
//		new Language ("Fran\u00e7ais",
//			AD_Language_fr_FR,  Locale.FRANCE,  null, null),		//  dd.MM.yy
//		new Language ("Fran\u00e7ais (CA)",
//			AD_Language_fr_CA,  new Locale("fr","CA"),  true, "MM/dd/yyyy"),	// MM/dd/yy
//		new Language ("Hrvatski",
//			AD_Language_hr_HR, new Locale("hr", "HR"), null, "dd.MM.yyyy"),
//		new Language ("Indonesia Bahasa",
//			AD_Language_in_ID, new Locale("in","ID"), false, "dd-MM-yyyy"),
...
//			AD_Language_ms_MY, new Locale("ms","MY"), false, "dd-MM-yyyy"),
//		new Language ("Magyar (HU)",
//			AD_Language_hu_HU,  new Locale("hu","HU"), false, "yyyy.MM.dd"),
//		new Language ("Nederlands",
//			AD_Language_nl_NL, new Locale("nl","NL"), false, "dd-MM-yyyy"),
//		new Language ("Norsk",
//			AD_Language_no_NO,  new Locale("no","NO"), false, "dd/MM/yyyy"),
//		new Language ("Polski",
//			AD_Language_pl_PL, new Locale("pl","PL"), false, "dd-MM-yyyy"),
//		new Language ("Portuguese (BR)",
//			AD_Language_pt_BR, new Locale("pt","BR"), false, "dd/MM/yyyy"),
//		new Language ("Rom\u00e2n\u0103",
//			AD_Language_ro_RO, new Locale("ro","RO"), false, "dd.MM.yyyy"),
//		new Language ("\u0420\u0443\u0441\u0441\u043a\u0438\u0439 (Russian)",
//			AD_Language_ru_RU, new Locale("ru","RU"), false, "dd-MM-yyyy"),
...
//			AD_Language_sv_SE,  new Locale("sv","SE"),  false, "yyyy-MM-dd"),
//		new Language ("\u0e44\u0e17\u0e22 (TH)",
//			AD_Language_th_TH,  new Locale("th","TH"), false, "dd/MM/yyyy"),
//		new Language ("Vi\u1EC7t Nam",
//			AD_Language_vi_VN, new Locale("vi","VN"), false, "dd-MM-yyyy"),
...
//			AD_Language_zh_TW,  Locale.TAIWAN,  null, null)		//  dd.MM.yy
	 ...
	 * @return Language[]
	 */
	public static Language[] getAvaliableLanguages() {
		return s_languages;
	}
...
//	}   //  getLanguage
	...
	public Language (String name, String AD_Language, Locale locale,
		Boolean decimalPoint, String javaDatePattern)
	{
