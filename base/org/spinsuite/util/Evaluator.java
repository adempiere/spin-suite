 ...
 *  @contributor <a href="mailto:yamelsenih@gmail.com">Yamel Senih</a> 2014-09-04, 20:36:59
...
public class Evaluator {
	...
	public static boolean evaluateLogic (Evaluatee source, String logic)
	{
		...
		{
			Log.e("Evaluator", "Logic does not comply with format "
		...
		while (st.hasMoreTokens())
		{
			...
			{
				Log.e("Evaluator", "Logic operant '|' or '&' expected => " + logic);
				return false;
			}
		}	// hasMoreTokens
		return retValue;
	...
	private static boolean evaluateLogicTuple (Evaluatee source, String logic)
	{
		...
		if (st.countTokens() != 3)
		{
			Log.e("Evaluator", "Logic tuple does not comply with format "
