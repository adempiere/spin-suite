...
public class DisplayImageTextItem extends DisplayRecordItem {
	 ...
	 * @param pValue
	 */
	public DisplayImageTextItem(int pRecord_ID, String pValue) {
	 ...
	 * @param pImageURL
	 */
	public DisplayImageTextItem(int pRecord_ID, String pValue, String pImageURL) {
	 ...
	 * @param m_Image
	 */
	public DisplayImageTextItem(int pRecord_ID, String pValue, String m_Description, Bitmap m_Image) {
