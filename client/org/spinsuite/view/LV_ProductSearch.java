 ...
 *
 */
public class LV_ProductSearch extends Activity {
	
	/**	Adapter					*/
	private SearchAdapter 			m_SearchAdapter 	= null;
	/**	Main Layout				*/
	private ScrollView				sv_ProductSearch 			= null;
	/**	Table Layout			*/
	private TableLayout 			v_tableLayout 		= null;
	/**	List View				*/
	private ListView				lv_ProductSearch 			= null;
	/**	Field					*/
	...
	public void onCreate(Bundle icicle) {
		...
		super.setContentView(R.layout.v_product_search);
    	//	Get Field
		...
		//	
		sv_ProductSearch = (ScrollView) findViewById(R.id.sv_ProductSearch);
    	//	Table Layout
    	v_tableLayout = new TableLayout(this);
    	sv_ProductSearch.addView(v_tableLayout);
    	//	
		lv_ProductSearch = (ListView) findViewById(R.id.lv_ProductSearch);
		//	
		if(m_SPS_Table_ID != 0)
    	...
    	//	Listener
		lv_ProductSearch.setOnItemClickListener(new ListView.OnItemClickListener() {
			@Override
	...
	private void loadConfig() {
		...
		//	Hide
		sv_ProductSearch.setVisibility(LinearLayout.GONE);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.action_add 
			...
			//	Show
			if(sv_ProductSearch.getVisibility() == LinearLayout.GONE) {
				sv_ProductSearch.setVisibility(LinearLayout.VISIBLE);
	...
	private class LoadViewTask extends AsyncTask<Void, Integer, Integer> {
	    ...
	    protected boolean loadView() {
			...
			lv_ProductSearch.setAdapter(m_SearchAdapter);
			//	
